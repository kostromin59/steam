...
func (x *CCloud_ClientLogUploadRequest_Notification) Reset() {
	*x = CCloud_ClientLogUploadRequest_Notification{}
	mi := &file_service_cloud_proto_msgTypes[31]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_ClientLogUploadRequest_Notification) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{31}
}
...
func (x *CCloud_CommitHTTPUpload_Request) Reset() {
	*x = CCloud_CommitHTTPUpload_Request{}
	mi := &file_service_cloud_proto_msgTypes[32]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CommitHTTPUpload_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{32}
}
...
func (x *CCloud_CommitHTTPUpload_Response) Reset() {
	*x = CCloud_CommitHTTPUpload_Response{}
	mi := &file_service_cloud_proto_msgTypes[33]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CommitHTTPUpload_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{33}
}
...
func (x *CCloud_CommitUGCUpload_Request) Reset() {
	*x = CCloud_CommitUGCUpload_Request{}
	mi := &file_service_cloud_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CommitUGCUpload_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{34}
}
...
func (x *CCloud_CommitUGCUpload_Response) Reset() {
	*x = CCloud_CommitUGCUpload_Response{}
	mi := &file_service_cloud_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CommitUGCUpload_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{35}
}
...
func (x *CCloud_CompleteAppUploadBatch_Notification) Reset() {
	*x = CCloud_CompleteAppUploadBatch_Notification{}
	mi := &file_service_cloud_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CompleteAppUploadBatch_Notification) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{36}
}
...
func (x *CCloud_CompleteAppUploadBatch_Request) Reset() {
	*x = CCloud_CompleteAppUploadBatch_Request{}
	mi := &file_service_cloud_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CompleteAppUploadBatch_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{37}
}
...
func (x *CCloud_CompleteAppUploadBatch_Response) Reset() {
	*x = CCloud_CompleteAppUploadBatch_Response{}
	mi := &file_service_cloud_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_CompleteAppUploadBatch_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{38}
}
...
func (x *CCloud_Delete_Request) Reset() {
	*x = CCloud_Delete_Request{}
	mi := &file_service_cloud_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_Delete_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{39}
}
...
func (x *CCloud_Delete_Response) Reset() {
	*x = CCloud_Delete_Response{}
	mi := &file_service_cloud_proto_msgTypes[40]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_Delete_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{40}
}
...
func (x *CCloud_EnumerateUserFiles_Request) Reset() {
	*x = CCloud_EnumerateUserFiles_Request{}
	mi := &file_service_cloud_proto_msgTypes[41]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_EnumerateUserFiles_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{41}
}
...
func (x *CCloud_EnumerateUserFiles_Response) Reset() {
	*x = CCloud_EnumerateUserFiles_Response{}
	mi := &file_service_cloud_proto_msgTypes[42]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_EnumerateUserFiles_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{42}
}
...
func (x *CCloud_ExternalStorageTransferReport_Notification) Reset() {
	*x = CCloud_ExternalStorageTransferReport_Notification{}
	mi := &file_service_cloud_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_ExternalStorageTransferReport_Notification) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{43}
}
...
func (x *CCloud_GetAppFileChangelist_Request) Reset() {
	*x = CCloud_GetAppFileChangelist_Request{}
	mi := &file_service_cloud_proto_msgTypes[44]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetAppFileChangelist_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{44}
}
...
func (x *CCloud_GetAppFileChangelist_Response) Reset() {
	*x = CCloud_GetAppFileChangelist_Response{}
	mi := &file_service_cloud_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetAppFileChangelist_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{45}
}
...
func (x *CCloud_GetClientEncryptionKey_Request) Reset() {
	*x = CCloud_GetClientEncryptionKey_Request{}
	mi := &file_service_cloud_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetClientEncryptionKey_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{46}
}
...
func (x *CCloud_GetClientEncryptionKey_Response) Reset() {
	*x = CCloud_GetClientEncryptionKey_Response{}
	mi := &file_service_cloud_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetClientEncryptionKey_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{47}
}
...
func (x *CCloud_GetFileDetails_Request) Reset() {
	*x = CCloud_GetFileDetails_Request{}
	mi := &file_service_cloud_proto_msgTypes[48]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetFileDetails_Request) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{48}
}
...
func (x *CCloud_GetFileDetails_Response) Reset() {
	*x = CCloud_GetFileDetails_Response{}
	mi := &file_service_cloud_proto_msgTypes[49]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_GetFileDetails_Response) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{49}
}
...
func (x *CCloud_UserFile) Reset() {
	*x = CCloud_UserFile{}
	mi := &file_service_cloud_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CCloud_UserFile) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{50}
}
...
func (x *ClientCloudFileUploadBlockDetails) Reset() {
	*x = ClientCloudFileUploadBlockDetails{}
	mi := &file_service_cloud_proto_msgTypes[51]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientCloudFileUploadBlockDetails) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{51}
}
...
func (x *ClientCloudFileUploadBlockDetails_HTTPHeaders) Reset() {
	*x = ClientCloudFileUploadBlockDetails_HTTPHeaders{}
	mi := &file_service_cloud_proto_msgTypes[52]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientCloudFileUploadBlockDetails_HTTPHeaders) Descriptor() ([]byte, []int) {
	return file_service_cloud_proto_rawDescGZIP(), []int{52}
}
...
const file_service_cloud_proto_rawDesc = "" +
	"\n" +
	"\x13service_cloud.proto\x1a\x11common_base.proto\x1a\fcommon.proto\"k\n" +
	"'CCloud_AppCloudStateChange_Notification\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12*\n" +
	"\x11app_change_number\x18\x02 \x01(\x04R\x0fappChangeNumber\"\xc4\x02\n" +
	...
	"\rraw_file_size\x18\x04 \x01(\rR\vrawFileSize\x12-\n" +
	"\rpersist_state\x18\x05 \x01(\x05B\b\x82\xb5\x18\x04enumR\fpersistState\x12*\n" +
	"\x11platforms_to_sync\x18\x06 \x01(\rR\x0fplatformsToSync\x12*\n" +
	"\x11path_prefix_index\x18\a \x01(\rR\x0fpathPrefixIndex\x12,\n" +
	"\x12machine_name_index\x18\b \x01(\rR\x10machineNameIndex\"\xec\x01\n" +
	...
	"\x19pending_remote_operations\x18\x01 \x03(\v2\x1e.CCloud_PendingRemoteOperationR\x17pendingRemoteOperations\"T\n" +
	"\x1fCCloud_AppSessionResume_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x1b\n" +
	"\tclient_id\x18\x02 \x01(\x04R\bclientId\"\"\n" +
	" CCloud_AppSessionResume_Response\"\xaa\x01\n" +
	...
	"!CCloud_AppSessionSuspend_Response\"\xec\x01\n" +
	...
	"\x11app_change_number\x18\x04 \x01(\x04R\x0fappChangeNumber\"\xe5\x02\n" +
	...
	"\x0fupload_batch_id\x18\t \x01(\x04R\ruploadBatchId\"\xff\x01\n" +
	...
	"\x0frequest_headers\x18\x06 \x03(\v2,.CCloud_BeginHTTPUpload_Response_HTTPHeadersR\x0erequestHeaders\"W\n" +
	"+CCloud_BeginHTTPUpload_Response_HTTPHeaders\x12\x12\n" +
	...
	"\fcontent_type\x18\x05 \x01(\tR\vcontentType\"\xae\x02\n" +
	"\x1eCCloud_BeginUGCUpload_Response\x12/\n" +
	"\x0estorage_system\x18\x01 \x01(\x05B\b\x82\xb5\x18\x04enumR\rstorageSystem\x12\x14\n" +
	...
	"\x0frequest_headers\x18\a \x03(\v2+.CCloud_BeginUGCUpload_Response_HTTPHeadersR\x0erequestHeaders\"V\n" +
	"*CCloud_BeginUGCUpload_Response_HTTPHeaders\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	...
	"\bduration\x18\a \x01(\rR\bduration\"\xbe\x03\n" +
	...
	"\x0fupload_batch_id\x18\r \x01(\x04R\ruploadBatchId\"\x95\x01\n" +
	...
	"\x0efile_committed\x18\x01 \x01(\bR\rfileCommitted\"p\n" +
	",CCloud_ClientConflictResolution_Notification\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12*\n" +
	"\x11chose_local_files\x18\x02 \x01(\bR\x0fchoseLocalFiles\"\xa9\x01\n" +
	...
	" CCloud_ClientDeleteFile_Response\"\x8c\x01\n" +
	...
	" \x03(\v2/.CCloud_ClientFileDownload_Response_HTTPHeadersR\x0erequestHeaders\x12\x1c\n" +
	"\tencrypted\x18\v \x01(\bR\tencrypted\"Z\n" +
	".CCloud_ClientFileDownload_Response_HTTPHeaders\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	...
	"\rmax_num_bytes\x18\x04 \x01(\x04R\vmaxNumBytes\"G\n" +
	...
	"\n" +
	"request_id\x18\x02 \x01(\x04R\trequestId\"K\n" +
	"*CCloud_ClientLogUploadRequest_Notification\x12\x1d\n" +
	"\n" +
	"request_id\x18\x01 \x01(\x04R\trequestId\"\x9d\x01\n" +
	...
	"\x0efile_committed\x18\x01 \x01(\bR\rfileCommitted\"{\n" +
	...
	"\x0efile_committed\x18\x01 \x01(\bR\rfileCommitted\"\x82\x01\n" +
	...
	"\bbatch_id\x18\x02 \x01(\x04R\abatchId\x12#\n" +
	"\rbatch_eresult\x18\x03 \x01(\rR\fbatchEresult\"(\n" +
	"&CCloud_CompleteAppUploadBatch_Response\"q\n" +
	...
	"\x16CCloud_Delete_Response\"\x9b\x01\n" +
	...
	"\x14time_to_last_byte_ms\x18\x10 \x01(\rR\x10timeToLastByteMs\"m\n" +
	"#CCloud_GetAppFileChangelist_Request\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x120\n" +
	"\x14synced_change_number\x18\x02 \x01(\x04R\x12syncedChangeNumber\"\x9b\x02\n" +
	...
	"\x0fapp_buildid_hwm\x18\x06 \x01(\x04R\rappBuildidHwm\"'\n" +
	...
	"\x03crc\x18\x02 \x01(\x05R\x03crc\"K\n" +
	"\x1dCCloud_GetFileDetails_Request\x12\x14\n" +
	"\x05ugcid\x18\x01 \x01(\x04R\x05ugcid\x12\x14\n" +
	"\x05appid\x18\x02 \x01(\rR\x05appid\"L\n" +
	"\x1eCCloud_GetFileDetails_Response\x12*\n" +
	"\adetails\x18\x01 \x01(\v2\x10.CCloud_UserFileR\adetails\"\xac\x02\n" +
	...
	"httpMethod\x12W\n" +
	"\x0frequest_headers\x18\x05 \x03(\v2..ClientCloudFileUploadBlockDetails_HTTPHeadersR\x0erequestHeaders\x12!\n" +
	...
	"\x0fmay_parallelize\x18\t \x01(\bR\x0emayParallelize\"Y\n" +
	"-ClientCloudFileUploadBlockDetails_HTTPHeaders\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value2\x9d\x12\n" +
	"\x05Cloud\x12`\n" +
	"\x13BeginAppUploadBatch\x12#.CCloud_BeginAppUploadBatch_Request\x1a$.CCloud_BeginAppUploadBatch_Response\x12T\n" +
	"\x0fBeginHTTPUpload\x12\x1f.CCloud_BeginHTTPUpload_Request\x1a .CCloud_BeginHTTPUpload_Response\x12Q\n" +
	"\x0eBeginUGCUpload\x12\x1e.CCloud_BeginUGCUpload_Request\x1a\x1f.CCloud_BeginUGCUpload_Response\x128\n" +
	"\tCDNReport\x12\x1e.CCloud_CDNReport_Notification\x1a\v.NoResponse\x12f\n" +
	"\x15ClientBeginFileUpload\x12%.CCloud_ClientBeginFileUpload_Request\x1a&.CCloud_ClientBeginFileUpload_Response\x12i\n" +
	"\x16ClientCommitFileUpload\x12&.CCloud_ClientCommitFileUpload_Request\x1a'.CCloud_ClientCommitFileUpload_Response\x12V\n" +
	"\x18ClientConflictResolution\x12-.CCloud_ClientConflictResolution_Notification\x1a\v.NoResponse\x12W\n" +
	"\x10ClientDeleteFile\x12 .CCloud_ClientDeleteFile_Request\x1a!.CCloud_ClientDeleteFile_Response\x12]\n" +
	"\x12ClientFileDownload\x12\".CCloud_ClientFileDownload_Request\x1a#.CCloud_ClientFileDownload_Response\x12i\n" +
	"\x16ClientGetAppQuotaUsage\x12&.CCloud_ClientGetAppQuotaUsage_Request\x1a'.CCloud_ClientGetAppQuotaUsage_Response\x12N\n" +
	"\x14ClientLogUploadCheck\x12).CCloud_ClientLogUploadCheck_Notification\x1a\v.NoResponse\x12T\n" +
	"\x17ClientLogUploadComplete\x12,.CCloud_ClientLogUploadComplete_Notification\x1a\v.NoResponse\x12W\n" +
	"\x10CommitHTTPUpload\x12 .CCloud_CommitHTTPUpload_Request\x1a!.CCloud_CommitHTTPUpload_Response\x12T\n" +
	"\x0fCommitUGCUpload\x12\x1f.CCloud_CommitUGCUpload_Request\x1a .CCloud_CommitUGCUpload_Response\x12R\n" +
	"\x16CompleteAppUploadBatch\x12+.CCloud_CompleteAppUploadBatch_Notification\x1a\v.NoResponse\x12q\n" +
	"\x1eCompleteAppUploadBatchBlocking\x12&.CCloud_CompleteAppUploadBatch_Request\x1a'.CCloud_CompleteAppUploadBatch_Response\x129\n" +
	"\x06Delete\x12\x16.CCloud_Delete_Request\x1a\x17.CCloud_Delete_Response\x12]\n" +
	"\x12EnumerateUserFiles\x12\".CCloud_EnumerateUserFiles_Request\x1a#.CCloud_EnumerateUserFiles_Response\x12`\n" +
	"\x1dExternalStorageTransferReport\x122.CCloud_ExternalStorageTransferReport_Notification\x1a\v.NoResponse\x12c\n" +
	"\x14GetAppFileChangelist\x12$.CCloud_GetAppFileChangelist_Request\x1a%.CCloud_GetAppFileChangelist_Response\x12i\n" +
	"\x16GetClientEncryptionKey\x12&.CCloud_GetClientEncryptionKey_Request\x1a'.CCloud_GetClientEncryptionKey_Response\x12Q\n" +
	"\x0eGetFileDetails\x12\x1e.CCloud_GetFileDetails_Request\x1a\x1f.CCloud_GetFileDetails_Response\x12W\n" +
	"\x10ResumeAppSession\x12 .CCloud_AppSessionResume_Request\x1a!.CCloud_AppSessionResume_Response\x125\n" +
	"\x15SignalAppExitSyncDone\x12\x0f.NotImplemented\x1a\v.NoResponse\x12Z\n" +
	"\x15SignalAppLaunchIntent\x12\x1f.CCloud_AppLaunchIntent_Request\x1a .CCloud_AppLaunchIntent_Response\x12Z\n" +
	"\x11SuspendAppSession\x12!.CCloud_AppSessionSuspend_Request\x1a\".CCloud_AppSessionSuspend_Response2\xb0\x01\n" +
	"\vCloudClient\x12R\n" +
	"\x16ClientLogUploadRequest\x12+.CCloud_ClientLogUploadRequest_Notification\x1a\v.NoResponse\x12M\n" +
	"\x14NotifyAppStateChange\x12(.CCloud_AppCloudStateChange_Notification\x1a\v.NoResponse"

var (
	file_service_cloud_proto_rawDescOnce sync.Once
	file_service_cloud_proto_rawDescData []byte
)

func file_service_cloud_proto_rawDescGZIP() []byte {
	file_service_cloud_proto_rawDescOnce.Do(func() {
		file_service_cloud_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_service_cloud_proto_rawDesc), len(file_service_cloud_proto_rawDesc)))
	})
	return file_service_cloud_proto_rawDescData
}

var file_service_cloud_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_service_cloud_proto_goTypes = []any{
	...
	(*CCloud_AppLaunchIntent_Request)(nil),                    // 2: CCloud_AppLaunchIntent_Request
	(*CCloud_AppLaunchIntent_Response)(nil),                   // 3: CCloud_AppLaunchIntent_Response
	(*CCloud_AppSessionResume_Request)(nil),                   // 4: CCloud_AppSessionResume_Request
	(*CCloud_AppSessionResume_Response)(nil),                  // 5: CCloud_AppSessionResume_Response
	(*CCloud_AppSessionSuspend_Request)(nil),                  // 6: CCloud_AppSessionSuspend_Request
	(*CCloud_AppSessionSuspend_Response)(nil),                 // 7: CCloud_AppSessionSuspend_Response
	(*CCloud_BeginAppUploadBatch_Request)(nil),                // 8: CCloud_BeginAppUploadBatch_Request
	(*CCloud_BeginAppUploadBatch_Response)(nil),               // 9: CCloud_BeginAppUploadBatch_Response
	(*CCloud_BeginHTTPUpload_Request)(nil),                    // 10: CCloud_BeginHTTPUpload_Request
	(*CCloud_BeginHTTPUpload_Response)(nil),                   // 11: CCloud_BeginHTTPUpload_Response
	(*CCloud_BeginHTTPUpload_Response_HTTPHeaders)(nil),       // 12: CCloud_BeginHTTPUpload_Response_HTTPHeaders
	(*CCloud_BeginUGCUpload_Request)(nil),                     // 13: CCloud_BeginUGCUpload_Request
	(*CCloud_BeginUGCUpload_Response)(nil),                    // 14: CCloud_BeginUGCUpload_Response
	(*CCloud_BeginUGCUpload_Response_HTTPHeaders)(nil),        // 15: CCloud_BeginUGCUpload_Response_HTTPHeaders
	(*CCloud_CDNReport_Notification)(nil),                     // 16: CCloud_CDNReport_Notification
	(*CCloud_ClientBeginFileUpload_Request)(nil),              // 17: CCloud_ClientBeginFileUpload_Request
	(*CCloud_ClientBeginFileUpload_Response)(nil),             // 18: CCloud_ClientBeginFileUpload_Response
	(*CCloud_ClientCommitFileUpload_Request)(nil),             // 19: CCloud_ClientCommitFileUpload_Request
	(*CCloud_ClientCommitFileUpload_Response)(nil),            // 20: CCloud_ClientCommitFileUpload_Response
	(*CCloud_ClientConflictResolution_Notification)(nil),      // 21: CCloud_ClientConflictResolution_Notification
	(*CCloud_ClientDeleteFile_Request)(nil),                   // 22: CCloud_ClientDeleteFile_Request
	(*CCloud_ClientDeleteFile_Response)(nil),                  // 23: CCloud_ClientDeleteFile_Response
	(*CCloud_ClientFileDownload_Request)(nil),                 // 24: CCloud_ClientFileDownload_Request
	(*CCloud_ClientFileDownload_Response)(nil),                // 25: CCloud_ClientFileDownload_Response
	(*CCloud_ClientFileDownload_Response_HTTPHeaders)(nil),    // 26: CCloud_ClientFileDownload_Response_HTTPHeaders
	(*CCloud_ClientGetAppQuotaUsage_Request)(nil),             // 27: CCloud_ClientGetAppQuotaUsage_Request
	(*CCloud_ClientGetAppQuotaUsage_Response)(nil),            // 28: CCloud_ClientGetAppQuotaUsage_Response
	(*CCloud_ClientLogUploadCheck_Notification)(nil),          // 29: CCloud_ClientLogUploadCheck_Notification
	(*CCloud_ClientLogUploadComplete_Notification)(nil),       // 30: CCloud_ClientLogUploadComplete_Notification
	(*CCloud_ClientLogUploadRequest_Notification)(nil),        // 31: CCloud_ClientLogUploadRequest_Notification
	(*CCloud_CommitHTTPUpload_Request)(nil),                   // 32: CCloud_CommitHTTPUpload_Request
	(*CCloud_CommitHTTPUpload_Response)(nil),                  // 33: CCloud_CommitHTTPUpload_Response
	(*CCloud_CommitUGCUpload_Request)(nil),                    // 34: CCloud_CommitUGCUpload_Request
	(*CCloud_CommitUGCUpload_Response)(nil),                   // 35: CCloud_CommitUGCUpload_Response
	(*CCloud_CompleteAppUploadBatch_Notification)(nil),        // 36: CCloud_CompleteAppUploadBatch_Notification
	(*CCloud_CompleteAppUploadBatch_Request)(nil),             // 37: CCloud_CompleteAppUploadBatch_Request
	(*CCloud_CompleteAppUploadBatch_Response)(nil),            // 38: CCloud_CompleteAppUploadBatch_Response
	(*CCloud_Delete_Request)(nil),                             // 39: CCloud_Delete_Request
	(*CCloud_Delete_Response)(nil),                            // 40: CCloud_Delete_Response
	(*CCloud_EnumerateUserFiles_Request)(nil),                 // 41: CCloud_EnumerateUserFiles_Request
	(*CCloud_EnumerateUserFiles_Response)(nil),                // 42: CCloud_EnumerateUserFiles_Response
	(*CCloud_ExternalStorageTransferReport_Notification)(nil), // 43: CCloud_ExternalStorageTransferReport_Notification
	(*CCloud_GetAppFileChangelist_Request)(nil),               // 44: CCloud_GetAppFileChangelist_Request
	(*CCloud_GetAppFileChangelist_Response)(nil),              // 45: CCloud_GetAppFileChangelist_Response
	(*CCloud_GetClientEncryptionKey_Request)(nil),             // 46: CCloud_GetClientEncryptionKey_Request
	(*CCloud_GetClientEncryptionKey_Response)(nil),            // 47: CCloud_GetClientEncryptionKey_Response
	(*CCloud_GetFileDetails_Request)(nil),                     // 48: CCloud_GetFileDetails_Request
	(*CCloud_GetFileDetails_Response)(nil),                    // 49: CCloud_GetFileDetails_Response
	(*CCloud_UserFile)(nil),                                   // 50: CCloud_UserFile
	(*ClientCloudFileUploadBlockDetails)(nil),                 // 51: ClientCloudFileUploadBlockDetails
	(*ClientCloudFileUploadBlockDetails_HTTPHeaders)(nil),     // 52: ClientCloudFileUploadBlockDetails_HTTPHeaders
	(*CCloud_PendingRemoteOperation)(nil),                     // 53: CCloud_PendingRemoteOperation
	(*NotImplemented)(nil),                                    // 54: NotImplemented
	(*NoResponse)(nil),                                        // 55: NoResponse
}
var file_service_cloud_proto_depIdxs = []int32{
	53, // 0: CCloud_AppLaunchIntent_Response.pending_remote_operations:type_name -> CCloud_PendingRemoteOperation
	12, // 1: CCloud_BeginHTTPUpload_Response.request_headers:type_name -> CCloud_BeginHTTPUpload_Response_HTTPHeaders
	15, // 2: CCloud_BeginUGCUpload_Response.request_headers:type_name -> CCloud_BeginUGCUpload_Response_HTTPHeaders
	51, // 3: CCloud_ClientBeginFileUpload_Response.block_requests:type_name -> ClientCloudFileUploadBlockDetails
	26, // 4: CCloud_ClientFileDownload_Response.request_headers:type_name -> CCloud_ClientFileDownload_Response_HTTPHeaders
	50, // 5: CCloud_EnumerateUserFiles_Response.files:type_name -> CCloud_UserFile
	1,  // 6: CCloud_GetAppFileChangelist_Response.files:type_name -> CCloud_AppFileInfo
	50, // 7: CCloud_GetFileDetails_Response.details:type_name -> CCloud_UserFile
	52, // 8: ClientCloudFileUploadBlockDetails.request_headers:type_name -> ClientCloudFileUploadBlockDetails_HTTPHeaders
	8,  // 9: Cloud.BeginAppUploadBatch:input_type -> CCloud_BeginAppUploadBatch_Request
	10, // 10: Cloud.BeginHTTPUpload:input_type -> CCloud_BeginHTTPUpload_Request
	13, // 11: Cloud.BeginUGCUpload:input_type -> CCloud_BeginUGCUpload_Request
	16, // 12: Cloud.CDNReport:input_type -> CCloud_CDNReport_Notification
	17, // 13: Cloud.ClientBeginFileUpload:input_type -> CCloud_ClientBeginFileUpload_Request
	19, // 14: Cloud.ClientCommitFileUpload:input_type -> CCloud_ClientCommitFileUpload_Request
	21, // 15: Cloud.ClientConflictResolution:input_type -> CCloud_ClientConflictResolution_Notification
	22, // 16: Cloud.ClientDeleteFile:input_type -> CCloud_ClientDeleteFile_Request
	24, // 17: Cloud.ClientFileDownload:input_type -> CCloud_ClientFileDownload_Request
	27, // 18: Cloud.ClientGetAppQuotaUsage:input_type -> CCloud_ClientGetAppQuotaUsage_Request
	29, // 19: Cloud.ClientLogUploadCheck:input_type -> CCloud_ClientLogUploadCheck_Notification
	30, // 20: Cloud.ClientLogUploadComplete:input_type -> CCloud_ClientLogUploadComplete_Notification
	32, // 21: Cloud.CommitHTTPUpload:input_type -> CCloud_CommitHTTPUpload_Request
	34, // 22: Cloud.CommitUGCUpload:input_type -> CCloud_CommitUGCUpload_Request
	36, // 23: Cloud.CompleteAppUploadBatch:input_type -> CCloud_CompleteAppUploadBatch_Notification
	37, // 24: Cloud.CompleteAppUploadBatchBlocking:input_type -> CCloud_CompleteAppUploadBatch_Request
	39, // 25: Cloud.Delete:input_type -> CCloud_Delete_Request
	41, // 26: Cloud.EnumerateUserFiles:input_type -> CCloud_EnumerateUserFiles_Request
	43, // 27: Cloud.ExternalStorageTransferReport:input_type -> CCloud_ExternalStorageTransferReport_Notification
	44, // 28: Cloud.GetAppFileChangelist:input_type -> CCloud_GetAppFileChangelist_Request
	46, // 29: Cloud.GetClientEncryptionKey:input_type -> CCloud_GetClientEncryptionKey_Request
	48, // 30: Cloud.GetFileDetails:input_type -> CCloud_GetFileDetails_Request
	4,  // 31: Cloud.ResumeAppSession:input_type -> CCloud_AppSessionResume_Request
	54, // 32: Cloud.SignalAppExitSyncDone:input_type -> NotImplemented
	2,  // 33: Cloud.SignalAppLaunchIntent:input_type -> CCloud_AppLaunchIntent_Request
	6,  // 34: Cloud.SuspendAppSession:input_type -> CCloud_AppSessionSuspend_Request
	31, // 35: CloudClient.ClientLogUploadRequest:input_type -> CCloud_ClientLogUploadRequest_Notification
	0,  // 36: CloudClient.NotifyAppStateChange:input_type -> CCloud_AppCloudStateChange_Notification
	9,  // 37: Cloud.BeginAppUploadBatch:output_type -> CCloud_BeginAppUploadBatch_Response
	11, // 38: Cloud.BeginHTTPUpload:output_type -> CCloud_BeginHTTPUpload_Response
	14, // 39: Cloud.BeginUGCUpload:output_type -> CCloud_BeginUGCUpload_Response
	55, // 40: Cloud.CDNReport:output_type -> NoResponse
	18, // 41: Cloud.ClientBeginFileUpload:output_type -> CCloud_ClientBeginFileUpload_Response
	20, // 42: Cloud.ClientCommitFileUpload:output_type -> CCloud_ClientCommitFileUpload_Response
	55, // 43: Cloud.ClientConflictResolution:output_type -> NoResponse
	23, // 44: Cloud.ClientDeleteFile:output_type -> CCloud_ClientDeleteFile_Response
	25, // 45: Cloud.ClientFileDownload:output_type -> CCloud_ClientFileDownload_Response
	28, // 46: Cloud.ClientGetAppQuotaUsage:output_type -> CCloud_ClientGetAppQuotaUsage_Response
	55, // 47: Cloud.ClientLogUploadCheck:output_type -> NoResponse
	55, // 48: Cloud.ClientLogUploadComplete:output_type -> NoResponse
	33, // 49: Cloud.CommitHTTPUpload:output_type -> CCloud_CommitHTTPUpload_Response
	35, // 50: Cloud.CommitUGCUpload:output_type -> CCloud_CommitUGCUpload_Response
	55, // 51: Cloud.CompleteAppUploadBatch:output_type -> NoResponse
	38, // 52: Cloud.CompleteAppUploadBatchBlocking:output_type -> CCloud_CompleteAppUploadBatch_Response
	40, // 53: Cloud.Delete:output_type -> CCloud_Delete_Response
	42, // 54: Cloud.EnumerateUserFiles:output_type -> CCloud_EnumerateUserFiles_Response
	55, // 55: Cloud.ExternalStorageTransferReport:output_type -> NoResponse
	45, // 56: Cloud.GetAppFileChangelist:output_type -> CCloud_GetAppFileChangelist_Response
	47, // 57: Cloud.GetClientEncryptionKey:output_type -> CCloud_GetClientEncryptionKey_Response
	49, // 58: Cloud.GetFileDetails:output_type -> CCloud_GetFileDetails_Response
	5,  // 59: Cloud.ResumeAppSession:output_type -> CCloud_AppSessionResume_Response
	55, // 60: Cloud.SignalAppExitSyncDone:output_type -> NoResponse
	3,  // 61: Cloud.SignalAppLaunchIntent:output_type -> CCloud_AppLaunchIntent_Response
	7,  // 62: Cloud.SuspendAppSession:output_type -> CCloud_AppSessionSuspend_Response
	55, // 63: CloudClient.ClientLogUploadRequest:output_type -> NoResponse
	55, // 64: CloudClient.NotifyAppStateChange:output_type -> NoResponse
...
func file_service_cloud_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_cloud_proto_rawDesc), len(file_service_cloud_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   53,
			NumExtensions: 0,
			NumServices:   2,
