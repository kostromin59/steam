...
func (x *CHelpRequestLogs_UploadUserApplicationLog_Request) Reset() {
	*x = CHelpRequestLogs_UploadUserApplicationLog_Request{}
	mi := &file_service_helprequestlogs_proto_msgTypes[0]
...
func (*CHelpRequestLogs_UploadUserApplicationLog_Request) Descriptor() ([]byte, []int) {
	return file_service_helprequestlogs_proto_rawDescGZIP(), []int{0}
}
...
func (x *CHelpRequestLogs_UploadUserApplicationLog_Response) Reset() {
	*x = CHelpRequestLogs_UploadUserApplicationLog_Response{}
	mi := &file_service_helprequestlogs_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CHelpRequestLogs_UploadUserApplicationLog_Response) Descriptor() ([]byte, []int) {
	return file_service_helprequestlogs_proto_rawDescGZIP(), []int{1}
}
...
var File_service_helprequestlogs_proto protoreflect.FileDescriptor

const file_service_helprequestlogs_proto_rawDesc = "" +
	"\n" +
	"\x1dservice_helprequestlogs.proto\"\xae\x01\n" +
	...
	"\x02id\x18\x01 \x01(\x04R\x02id2\x97\x01\n" +
	"\x0fHelpRequestLogs\x12\x83\x01\n" +
	"\x18UploadUserApplicationLog\x122.CHelpRequestLogs_UploadUserApplicationLog_Request\x1a3.CHelpRequestLogs_UploadUserApplicationLog_Response"

var (
	file_service_helprequestlogs_proto_rawDescOnce sync.Once
	file_service_helprequestlogs_proto_rawDescData []byte
)

func file_service_helprequestlogs_proto_rawDescGZIP() []byte {
	file_service_helprequestlogs_proto_rawDescOnce.Do(func() {
		file_service_helprequestlogs_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_service_helprequestlogs_proto_rawDesc), len(file_service_helprequestlogs_proto_rawDesc)))
	})
	return file_service_helprequestlogs_proto_rawDescData
}

var file_service_helprequestlogs_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_service_helprequestlogs_proto_goTypes = []any{
...
var file_service_helprequestlogs_proto_depIdxs = []int32{
...
func init() { file_service_helprequestlogs_proto_init() }
func file_service_helprequestlogs_proto_init() {
	if File_service_helprequestlogs_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_service_helprequestlogs_proto_rawDesc), len(file_service_helprequestlogs_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_service_helprequestlogs_proto_goTypes,
		DependencyIndexes: file_service_helprequestlogs_proto_depIdxs,
		MessageInfos:      file_service_helprequestlogs_proto_msgTypes,
	}.Build()
	File_service_helprequestlogs_proto = out.File
	file_service_helprequestlogs_proto_goTypes = nil
	file_service_helprequestlogs_proto_depIdxs = nil
}
