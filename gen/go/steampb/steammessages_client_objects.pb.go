...
func (x *CMsgNetworkDeviceConnect) GetApInfo() isCMsgNetworkDeviceConnect_ApInfo {
	if x != nil {
		return x.ApInfo
	}
	return nil
...
func (x *CMsgNetworkDeviceConnect) GetApKnown() *CMsgNetworkDeviceConnect_KnownAP {
	if x != nil {
		if x, ok := x.ApInfo.(*CMsgNetworkDeviceConnect_ApKnown); ok {
			return x.ApKnown
		}
	}
	return nil
...
func (x *CMsgNetworkDeviceConnect) GetApCustom() *CMsgNetworkDeviceConnect_CustomAP {
	if x != nil {
		if x, ok := x.ApInfo.(*CMsgNetworkDeviceConnect_ApCustom); ok {
			return x.ApCustom
		}
	}
	return nil
...
func (x *CMsgSystemPerfUpdateSettings) GetUpdate() isCMsgSystemPerfUpdateSettings_Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *CMsgSystemPerfUpdateSettings) GetResetToDefault() bool {
	if x != nil {
		if x, ok := x.Update.(*CMsgSystemPerfUpdateSettings_ResetToDefault); ok {
...
func (x *CMsgSystemPerfUpdateSettings) GetSettingsDelta() *CMsgSystemPerfSettings {
	if x != nil {
		if x, ok := x.Update.(*CMsgSystemPerfUpdateSettings_SettingsDelta); ok {
...
func (x *CMsgSystemPerfLegacySettingEntry) ProtoReflect() protoreflect.Message {
	mi := &file_steammessages_client_objects_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CMsgSystemPerfLegacySettingEntry.ProtoReflect.Descriptor instead.
...
func (x *CMsgSystemPerfLegacySettings) ProtoReflect() protoreflect.Message {
	mi := &file_steammessages_client_objects_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CMsgSystemPerfLegacySettings.ProtoReflect.Descriptor instead.
...
func (*CMsgSystemAudioVolume_ChannelEntry) Descriptor() ([]byte, []int) {
	return file_steammessages_client_objects_proto_rawDescGZIP(), []int{26, 0}
}
...
func (*CMsgCellList_Cell) Descriptor() ([]byte, []int) {
	return file_steammessages_client_objects_proto_rawDescGZIP(), []int{47, 0}
}
...
func (*CMsgMonitorInfo_MonitorInfo) Descriptor() ([]byte, []int) {
	return file_steammessages_client_objects_proto_rawDescGZIP(), []int{51, 0}
}
...
const file_steammessages_client_objects_proto_rawDesc = "" +
	"\n" +
	"\"steammessages_client_objects.proto\x1a\venums.proto\"\xd7\x02\n" +
	"0SteamMessagesClientIClientForcedEnumDependencies\x12B\n" +
	"\x01a\x18\x01 \x01(\x0e2\x15.EBluetoothDeviceType:\x1dk_BluetoothDeviceType_InvalidR\x01a\x12K\n" +
	"\x01b\x18\x02 \x01(\x0e2\x19.EStorageBlockContentType:\"k_EStorageBlockContentType_InvalidR\x01b\x12Q\n" +
	"\x01c\x18\x03 \x01(\x0e2\x1c.EStorageBlockFileSystemType:%k_EStorageBlockFileSystemType_InvalidR\x01c\x12?\n" +
	"\x01d\x18\x04 \x01(\x0e2\x13.ESDCardFormatStage:\x1ck_ESDCardFormatStage_InvalidR\x01d\"J\n" +
	"\x1bCMsgNetworkDeviceIP4Address\x12\x11\n" +
	"\x02ip\x18\x01 \x01(\x05:\x010R\x02ip\x12\x18\n" +
	"\anetmask\x18\x02 \x01(\x05R\anetmask\"\x86\x02\n" +
	"\x1aCMsgNetworkDeviceIP4Config\x12:\n" +
	"\taddresses\x18\x01 \x03(\v2\x1c.CMsgNetworkDeviceIP4AddressR\taddresses\x12\x15\n" +
	"\x06dns_ip\x18\x02 \x03(\x05R\x05dnsIp\x12\x1d\n" +
	"\n" +
	"gateway_ip\x18\x03 \x01(\x05R\tgatewayIp\x12&\n" +
	...
	"\x10is_default_route\x18\x05 \x01(\bR\x0eisDefaultRoute\x12$\n" +
	"\n" +
	"is_enabled\x18\x06 \x01(\b:\x05falseR\tisEnabled\"\xa6\b\n" +
	...
	"\x18is_wifi_scanning_enabled\x18\x03 \x01(\bR\x15isWifiScanningEnabled\x1a\xf0\x06\n" +
	"\x06Device\x12\x11\n" +
	"\x02id\x18\x01 \x01(\r:\x010R\x02id\x12\x14\n" +
	"\x05etype\x18\x02 \x01(\x05R\x05etype\x12\x16\n" +
	"\x06estate\x18\x03 \x01(\x05R\x06estate\x12\x10\n" +
	"\x03mac\x18\x04 \x01(\tR\x03mac\x12\x16\n" +
	"\x06vendor\x18\x05 \x01(\tR\x06vendor\x12\x18\n" +
	"\aproduct\x18\x06 \x01(\tR\aproduct\x12-\n" +
	"\x03ip4\x18\a \x01(\v2\x1b.CMsgNetworkDeviceIP4ConfigR\x03ip4\x12-\n" +
	"\x03ip6\x18\b \x01(\v2\x1b.CMsgNetworkDeviceIP6ConfigR\x03ip6\x12:\n" +
	"\x05wired\x18\t \x01(\v2$.CMsgNetworkDevicesData.Device.WiredR\x05wired\x12C\n" +
	"\bwireless\x18\n" +
	" \x01(\v2'.CMsgNetworkDevicesData.Device.WirelessR\bwireless\x1a|\n" +
	"\x05Wired\x12/\n" +
	"\x10is_cable_present\x18\x01 \x01(\b:\x05falseR\x0eisCablePresent\x12\x1d\n" +
	"\n" +
	"speed_mbit\x18\x02 \x01(\rR\tspeedMbit\x12#\n" +
	"\rfriendly_name\x18\x03 \x01(\tR\ffriendlyName\x1a\x83\x03\n" +
	"\bWireless\x12<\n" +
	"\x03aps\x18\x01 \x03(\v2*.CMsgNetworkDevicesData.Device.Wireless.APR\x03aps\x12/\n" +
	"\x13esecurity_supported\x18\x02 \x01(\x05R\x12esecuritySupported\x1a\x87\x02\n" +
	"\x02AP\x12\x11\n" +
	...
	"\x0eis_autoconnect\x18\x05 \x01(\bR\risAutoconnect\x12\x1c\n" +
	"\tesecurity\x18\x06 \x01(\x05R\tesecurity\x12\x1b\n" +
	"\tuser_name\x18\a \x01(\tR\buserName\x12\x1a\n" +
	"\bpassword\x18\b \x01(\tR\bpassword\x12!\n" +
	"\fstrength_raw\x18\t \x01(\x05R\vstrengthRaw\"\x94\x04\n" +
	...
	"\aKnownAP\x12\x13\n" +
	"\x05ap_id\x18\x01 \x01(\rR\x04apId\x1a<\n" +
	"\bCustomAP\x12\x12\n" +
	...
	"\x06drives\x18\x01 \x03(\v2\x1d.CMsgStorageDevicesData.DriveR\x06drives\x12H\n" +
	"\rblock_devices\x18\x02 \x03(\v2#.CMsgStorageDevicesData.BlockDeviceR\fblockDevices\x120\n" +
	...
	"\x0fis_trim_running\x18\x05 \x01(\bR\risTrimRunning\x1a\xfc\x01\n" +
	"\x05Drive\x12\x11\n" +
	"\x02id\x18\x01 \x01(\r:\x010R\x02id\x12\x14\n" +
	...
	"\n" +
	"media_type\x18\a \x01(\x0e2\x17.EStorageDriveMediaType: k_EStorageDriveMediaType_InvalidR\tmediaType\x1a\x8a\x04\n" +
	"\vBlockDevice\x12\x11\n" +
	"\x02id\x18\x01 \x01(\r:\x010R\x02id\x12\x1c\n" +
	...
	"\x0ffilesystem_type\x18\v \x01(\x0e2\x1c.EStorageBlockFileSystemType:%k_EStorageBlockFileSystemType_InvalidR\x0efilesystemType\x12\x1d\n" +
	"\n" +
	"mount_path\x18\f \x01(\tR\tmountPath\"\xa6\x02\n" +
	"\x1dCCloud_PendingRemoteOperation\x12_\n" +
	"\toperation\x18\x01 \x01(\x0e2\x1d.ECloudPendingRemoteOperation:\"k_ECloudPendingRemoteOperationNoneR\toperation\x12!\n" +
	"\fmachine_name\x18\x02 \x01(\tR\vmachineName\x12\x1b\n" +
	"\tclient_id\x18\x03 \x01(\x04R\bclientId\x12*\n" +
	"\x11time_last_updated\x18\x04 \x01(\rR\x0ftimeLastUpdated\x12\x17\n" +
	"\aos_type\x18\x05 \x01(\x05R\x06osType\x12\x1f\n" +
	"\vdevice_type\x18\x06 \x01(\x05R\n" +
	"deviceType\"b\n" +
	" CMsgCloudPendingRemoteOperations\x12>\n" +
	"\n" +
	"operations\x18\x01 \x03(\v2\x1e.CCloud_PendingRemoteOperationR\n" +
	"operations\"\xb1\x06\n" +
	"\x18CMsgBluetoothDevicesData\x12=\n" +
	"\badapters\x18\x01 \x03(\v2!.CMsgBluetoothDevicesData.AdapterR\badapters\x12:\n" +
	"\adevices\x18\x02 \x03(\v2 .CMsgBluetoothDevicesData.DeviceR\adevices\x12;\n" +
	"\amanager\x18\x03 \x01(\v2!.CMsgBluetoothDevicesData.ManagerR\amanager\x1a\x88\x01\n" +
	"\aAdapter\x12\x11\n" +
	...
	"\x0eis_discovering\x18\x05 \x01(\bR\risDiscovering\x1a\x94\x03\n" +
	"\x06Device\x12\x11\n" +
	...
	"\tis_paired\x18\a \x01(\bR\bisPaired\x12!\n" +
	"\fstrength_raw\x18\b \x01(\x05R\vstrengthRaw\x12!\n" +
	"\fwake_allowed\x18\t \x01(\bR\vwakeAllowed\x124\n" +
	"\x16wake_allowed_supported\x18\n" +
	" \x01(\bR\x14wakeAllowedSupported\x12'\n" +
	"\x0fbattery_percent\x18\v \x01(\x05R\x0ebatteryPercent\x1a;\n" +
	"\aManager\x120\n" +
	"\x14is_bluetooth_enabled\x18\x01 \x01(\bR\x12isBluetoothEnabled\"I\n" +
	...
	"\x0etx_bytes_total\x18\x03 \x01(\x03R\ftxBytesTotal\x12$\n" +
	"\x0erx_bytes_total\x18\x04 \x01(\x03R\frxBytesTotal\x12'\n" +
	"\x10tx_bytes_per_sec\x18\x05 \x01(\x05R\rtxBytesPerSec\x12'\n" +
	"\x10rx_bytes_per_sec\x18\x06 \x01(\x05R\rrxBytesPerSec\"\xbf\x01\n" +
	"\x1cCMsgSystemPerfDiagnosticInfo\x128\n" +
	"\aentries\x18\x01 \x03(\v2\x1e.CMsgSystemPerfDiagnosticEntryR\aentries\x12?\n" +
	"\n" +
	"interfaces\x18\x02 \x03(\v2\x1f.CMsgSystemPerfNetworkInterfaceR\n" +
	"interfaces\x12$\n" +
	"\x0ebattery_temp_c\x18\x03 \x01(\x02R\fbatteryTempC\"\xff\v\n" +
	...
	"\x1aperf_overlay_is_standalone\x18\a \x01(\bR\x17perfOverlayIsStandalone\x127\n" +
	"\x18is_dynamic_vrs_available\x18\b \x01(\bR\x15isDynamicVrsAvailable\x12U\n" +
	...
	"\rtdp_limit_min\x18\x0e \x01(\x05R\vtdpLimitMin\x12\"\n" +
	"\rtdp_limit_max\x18\x0f \x01(\x05R\vtdpLimitMax\x12Q\n" +
	"&display_external_refresh_manual_hz_min\x18\x13 \x01(\x05R!displayExternalRefreshManualHzMin\x12Q\n" +
	"&display_external_refresh_manual_hz_max\x18\x14 \x01(\x05R!displayExternalRefreshManualHzMax\x12;\n" +
	"\x1afps_limit_options_external\x18\x15 \x03(\x05R\x17fpsLimitOptionsExternal\x12(\n" +
	"\x10is_vrr_supported\x18\x17 \x01(\bR\x0eisVrrSupported\x12X\n" +
	"*is_dynamic_refresh_rate_in_steam_supported\x18\x18 \x01(\bR$isDynamicRefreshRateInSteamSupported\x12[\n" +
	"\x1fsplit_scaling_filters_available\x18\x1a \x03(\x0e2\x14.ESplitScalingFilterR\x1csplitScalingFiltersAvailable\x12[\n" +
	"\x1fsplit_scaling_scalers_available\x18\x1b \x03(\x0e2\x14.ESplitScalingScalerR\x1csplitScalingScalersAvailable\x12E\n" +
	"\x1fdisable_refresh_rate_management\x18\x1e \x01(\bR\x1cdisableRefreshRateManagement\"\x86\t\n" +
	"\x1cCMsgSystemPerfSettingsGlobal\x124\n" +
	"\x16diagnostic_update_rate\x18\x01 \x01(\x02R\x14diagnosticUpdateRate\x12t\n" +
	"\x1asystem_trace_service_state\x18\x02 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17systemTraceServiceState\x12\x80\x01\n" +
	" graphics_profiling_service_state\x18\x03 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x1dgraphicsProfilingServiceState\x12t\n" +
	"\x1aperf_overlay_service_state\x18\x04 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17perfOverlayServiceState\x12l\n" +
	"\x12perf_overlay_level\x18\x05 \x01(\x0e2\x1a.EGraphicsPerfOverlayLevel:\"k_EGraphicsPerfOverlayLevel_HiddenR\x10perfOverlayLevel\x12R\n" +
	"'is_show_perf_overlay_over_steam_enabled\x18\x06 \x01(\bR!isShowPerfOverlayOverSteamEnabled\x12?\n" +
	"\x1cis_advanced_settings_enabled\x18\a \x01(\bR\x19isAdvancedSettingsEnabled\x12R\n" +
	"&allow_external_display_refresh_control\x18\b \x01(\bR\"allowExternalDisplayRefreshControl\x12q\n" +
	"\x1bhdr_on_sdr_tonemap_operator\x18\f \x01(\x0e2\x14.EHDRToneMapOperator:\x1dk_EHDRToneMapOperator_InvalidR\x17hdrOnSdrTonemapOperator\x12>\n" +
	...
	"\ttdp_limit\x18\x05 \x01(\x05R\btdpLimit\x12H\n" +
	"\fcpu_governor\x18\x06 \x01(\x0e2\r.ECPUGovernor:\x16k_ECPUGovernor_InvalidR\vcpuGovernor\x125\n" +
	"\x17cpu_governor_manual_mhz\x18\a \x01(\x05R\x14cpuGovernorManualMhz\x12%\n" +
	"\x0escaling_filter\x18\b \x01(\x05R\rscalingFilter\x12#\n" +
	"\rfsr_sharpness\x18\t \x01(\x05R\ffsrSharpness\x12/\n" +
	"\x14is_fps_limit_enabled\x18\n" +
	" \x01(\bR\x11isFpsLimitEnabled\x12/\n" +
	...
	"\x0eis_vrr_enabled\x18\x14 \x01(\bR\fisVrrEnabled\x12G\n" +
	"!use_dynamic_refresh_rate_in_steam\x18\x17 \x01(\bR\x1cuseDynamicRefreshRateInSteam\x12e\n" +
	"\x14split_scaling_filter\x18\x18 \x01(\x0e2\x14.ESplitScalingFilter:\x1dk_ESplitScalingFilter_InvalidR\x12splitScalingFilter\x12e\n" +
	"\x14split_scaling_scaler\x18\x19 \x01(\x0e2\x14.ESplitScalingScaler:\x1dk_ESplitScalingScaler_InvalidR\x12splitScalingScaler\"\x87\x01\n" +
	"\x16CMsgSystemPerfSettings\x125\n" +
	"\x06global\x18\x01 \x01(\v2\x1d.CMsgSystemPerfSettingsGlobalR\x06global\x126\n" +
	"\aper_app\x18\x02 \x01(\v2\x1d.CMsgSystemPerfSettingsPerAppR\x06perApp\"\xd6\v\n" +
	"\x18CMsgSystemPerfSettingsV1\x124\n" +
	"\x16diagnostic_update_rate\x18\x01 \x01(\x02R\x14diagnosticUpdateRate\x12t\n" +
	"\x1asystem_trace_service_state\x18\x02 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17systemTraceServiceState\x12\x80\x01\n" +
	" graphics_profiling_service_state\x18\x03 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x1dgraphicsProfilingServiceState\x12t\n" +
	"\x1aperf_overlay_service_state\x18\x04 \x01(\x0e2\x14.ESystemServiceState:!k_ESystemServiceState_UnavailableR\x17perfOverlayServiceState\x12l\n" +
	"\x12perf_overlay_level\x18\x05 \x01(\x0e2\x1a.EGraphicsPerfOverlayLevel:\"k_EGraphicsPerfOverlayLevel_HiddenR\x10perfOverlayLevel\x12i\n" +
	"\x15gpu_performance_level\x18\x06 \x01(\x0e2\x15.EGPUPerformanceLevel:\x1ek_EGPUPerformanceLevel_InvalidR\x13gpuPerformanceLevel\x12;\n" +
	"\x1agpu_performance_manual_mhz\x18\a \x01(\x05R\x17gpuPerformanceManualMhz\x12\x1b\n" +
	"\tfps_limit\x18\b \x01(\x05R\bfpsLimit\x12C\n" +
	"\x1eis_variable_resolution_enabled\x18\t \x01(\bR\x1bisVariableResolutionEnabled\x12D\n" +
	"\x1fis_dynamic_refresh_rate_enabled\x18\n" +
	" \x01(\bR\x1bisDynamicRefreshRateEnabled\x12\x1b\n" +
	"\ttdp_limit\x18\v \x01(\x05R\btdpLimit\x12H\n" +
	"\fcpu_governor\x18\f \x01(\x0e2\r.ECPUGovernor:\x16k_ECPUGovernor_InvalidR\vcpuGovernor\x125\n" +
	"\x17cpu_governor_manual_mhz\x18\r \x01(\x05R\x14cpuGovernorManualMhz\x12%\n" +
	"\x0escaling_filter\x18\x0e \x01(\x05R\rscalingFilter\x12#\n" +
	"\rfsr_sharpness\x18\x0f \x01(\x05R\ffsrSharpness\x12/\n" +
	"\x14is_fps_limit_enabled\x18\x10 \x01(\bR\x11isFpsLimitEnabled\x12/\n" +
	"\x14is_tdp_limit_enabled\x18\x11 \x01(\bR\x11isTdpLimitEnabled\x12R\n" +
	"'is_show_perf_overlay_over_steam_enabled\x18\x12 \x01(\bR!isShowPerfOverlayOverSteamEnabled\x12<\n" +
	"\x1bis_low_latency_mode_enabled\x18\x13 \x01(\bR\x17isLowLatencyModeEnabled\x129\n" +
	"\x19display_refresh_manual_hz\x18\x14 \x01(\x05R\x16displayRefreshManualHz\x12>\n" +
	"\x1cis_game_perf_profile_enabled\x18\x15 \x01(\bR\x18isGamePerfProfileEnabled\"\xd6\x01\n" +
	"\x13CMsgSystemPerfState\x12-\n" +
	"\x06limits\x18\x01 \x01(\v2\x15.CMsgSystemPerfLimitsR\x06limits\x123\n" +
	"\bsettings\x18\x02 \x01(\v2\x17.CMsgSystemPerfSettingsR\bsettings\x12&\n" +
	"\x0fcurrent_game_id\x18\x03 \x01(\x04R\rcurrentGameId\x123\n" +
	"\x16active_profile_game_id\x18\x04 \x01(\x04R\x13activeProfileGameId\"\xde\x01\n" +
	"\x1cCMsgSystemPerfUpdateSettings\x12\x16\n" +
	"\x06gameid\x18\x01 \x01(\x04R\x06gameid\x12.\n" +
	"\x13skip_storage_update\x18\x04 \x01(\bR\x11skipStorageUpdate\x12*\n" +
	"\x10reset_to_default\x18\x02 \x01(\bH\x00R\x0eresetToDefault\x12@\n" +
	"\x0esettings_delta\x18\x03 \x01(\v2\x17.CMsgSystemPerfSettingsH\x00R\rsettingsDeltaB\b\n" +
	"\x06update\"\x85\x01\n" +
	" CMsgSystemPerfLegacySettingEntry\x12&\n" +
	"\x0fprofile_game_id\x18\x01 \x01(\x04R\rprofileGameId\x129\n" +
	"\bsettings\x18\x02 \x01(\v2\x1d.CMsgSystemPerfSettingsPerAppR\bsettings\"\xa2\x01\n" +
	"\x1cCMsgSystemPerfLegacySettings\x125\n" +
	"\x06global\x18\x01 \x01(\v2\x1d.CMsgSystemPerfSettingsGlobalR\x06global\x12K\n" +
	"\x10per_app_settings\x18\x02 \x03(\v2!.CMsgSystemPerfLegacySettingEntryR\x0eperAppSettings\"\xef\x02\n" +
	"\x19CMsgSystemDockUpdateState\x12=\n" +
	"\x05state\x18\x01 \x01(\x0e2\x0e.EUpdaterState:\x17k_EUpdaterState_InvalidR\x05state\x12,\n" +
	"\x12rtime_last_checked\x18\x02 \x01(\aR\x10rtimeLastChecked\x12'\n" +
	"\x0fversion_current\x18\x03 \x01(\tR\x0eversionCurrent\x12+\n" +
	"\x11version_available\x18\x04 \x01(\tR\x10versionAvailable\x12%\n" +
	"\x0estage_progress\x18\x05 \x01(\x02R\rstageProgress\x12<\n" +
	"\x1artime_estimated_completion\x18\x06 \x01(\aR\x18rtimeEstimatedCompletion\x12*\n" +
	"\x11old_fw_workaround\x18\a \x01(\x05R\x0foldFwWorkaround\"T\n" +
	"\x13CMsgSystemDockState\x12=\n" +
	"\fupdate_state\x18\x01 \x01(\v2\x1a.CMsgSystemDockUpdateStateR\vupdateState\"=\n" +
	"\x1cCMsgSystemDockUpdateFirmware\x12\x1d\n" +
	"\n" +
	"check_only\x18\x01 \x01(\bR\tcheckOnly\"\xe9\x01\n" +
	"\x15CMsgSystemAudioVolume\x12=\n" +
	"\aentries\x18\x01 \x03(\v2#.CMsgSystemAudioVolume.ChannelEntryR\aentries\x12\x19\n" +
	"\bis_muted\x18\x02 \x01(\bR\aisMuted\x1av\n" +
	"\fChannelEntry\x12N\n" +
	"\bechannel\x18\x01 \x01(\x0e2\x14.ESystemAudioChannel:\x1ck_SystemAudioChannel_InvalidR\bechannel\x12\x16\n" +
	"\x06volume\x18\x02 \x01(\x02R\x06volume\"Z\n" +
	"\x1cCMsgSystemAudioManagerObject\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12*\n" +
	"\x11rtime_last_update\x18\x02 \x01(\aR\x0frtimeLastUpdate\"\xad\x01\n" +
	"\x1cCMsgSystemAudioManagerDevice\x121\n" +
	"\x04base\x18\x01 \x01(\v2\x1d.CMsgSystemAudioManagerObjectR\x04base\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x12\n" +
	"\x04nick\x18\x03 \x01(\tR\x04nick\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x10\n" +
	"\x03api\x18\x05 \x01(\tR\x03api\"\xbe\x02\n" +
	"\x1aCMsgSystemAudioManagerNode\x121\n" +
	"\x04base\x18\x01 \x01(\v2\x1d.CMsgSystemAudioManagerObjectR\x04base\x12\x1b\n" +
	...
	"\n" +
	"edirection\x18\x06 \x01(\x0e2\x16.ESystemAudioDirection:\x1ek_SystemAudioDirection_InvalidR\n" +
	"edirection\x12.\n" +
	"\x06volume\x18\a \x01(\v2\x16.CMsgSystemAudioVolumeR\x06volume\"\xbe\x03\n" +
	"\x1aCMsgSystemAudioManagerPort\x121\n" +
	"\x04base\x18\x01 \x01(\v2\x1d.CMsgSystemAudioManagerObjectR\x04base\x12\x17\n" +
	"\anode_id\x18\x03 \x01(\rR\x06nodeId\x12\x12\n" +
	"\x04name\x18\x04 \x01(\tR\x04name\x12\x14\n" +
	"\x05alias\x18\x05 \x01(\tR\x05alias\x12J\n" +
	"\x05etype\x18\x06 \x01(\x0e2\x15.ESystemAudioPortType:\x1dk_SystemAudioPortType_InvalidR\x05etype\x12^\n" +
	"\n" +
	"edirection\x18\a \x01(\x0e2\x1a.ESystemAudioPortDirection:\"k_SystemAudioPortDirection_InvalidR\n" +
	"edirection\x12\x1f\n" +
	"\vis_physical\x18\b \x01(\bR\n" +
	"isPhysical\x12\x1f\n" +
	"\vis_terminal\x18\t \x01(\bR\n" +
	"isTerminal\x12\x1d\n" +
	"\n" +
	"is_control\x18\n" +
	" \x01(\bR\tisControl\x12\x1d\n" +
	"\n" +
	"is_monitor\x18\v \x01(\bR\tisMonitor\"\xe3\x01\n" +
	"\x1aCMsgSystemAudioManagerLink\x121\n" +
	"\x04base\x18\x01 \x01(\v2\x1d.CMsgSystemAudioManagerObjectR\x04base\x12$\n" +
	"\x0eoutput_node_id\x18\x02 \x01(\rR\foutputNodeId\x12$\n" +
	"\x0eoutput_port_id\x18\x03 \x01(\rR\foutputPortId\x12\"\n" +
	"\rinput_node_id\x18\x04 \x01(\rR\vinputNodeId\x12\"\n" +
	"\rinput_port_id\x18\x05 \x01(\rR\vinputPortId\"\xf1\x01\n" +
	"\x1dCMsgSystemAudioManagerStateHW\x127\n" +
	"\adevices\x18\x01 \x03(\v2\x1d.CMsgSystemAudioManagerDeviceR\adevices\x121\n" +
	"\x05nodes\x18\x02 \x03(\v2\x1b.CMsgSystemAudioManagerNodeR\x05nodes\x121\n" +
	"\x05ports\x18\x03 \x03(\v2\x1b.CMsgSystemAudioManagerPortR\x05ports\x121\n" +
	"\x05links\x18\x04 \x03(\v2\x1b.CMsgSystemAudioManagerLinkR\x05links\"\x8a\x01\n" +
	"\x1bCMsgSystemAudioManagerState\x12!\n" +
	"\frtime_filter\x18\x01 \x01(\aR\vrtimeFilter\x12\x18\n" +
	"\acounter\x18\x02 \x01(\x05R\acounter\x12.\n" +
	"\x02hw\x18\x03 \x01(\v2\x1e.CMsgSystemAudioManagerStateHWR\x02hw\"A\n" +
	"%CMsgSystemAudioManagerUpdateSomething\x12\x18\n" +
	"\acounter\x18\x01 \x01(\x05R\acounter\"t\n" +
	"\x15CMsgSystemDisplayMode\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x14\n" +
	"\x05width\x18\x02 \x01(\x05R\x05width\x12\x16\n" +
	"\x06height\x18\x03 \x01(\x05R\x06height\x12\x1d\n" +
	"\n" +
	"refresh_hz\x18\x04 \x01(\x05R\trefreshHz\"\xac\x05\n" +
	"\x11CMsgSystemDisplay\x12\x0e\n" +
	...
	"\n" +
	"is_enabled\x18\x05 \x01(\bR\tisEnabled\x12\x1f\n" +
	"\vis_internal\x18\x06 \x01(\bR\n" +
	"isInternal\x12*\n" +
	"\x11has_mode_override\x18\a \x01(\bR\x0fhasModeOverride\x12\x19\n" +
	"\bwidth_mm\x18\b \x01(\x05R\awidthMm\x12\x1b\n" +
	"\theight_mm\x18\t \x01(\x05R\bheightMm\x12&\n" +
	"\x0fcurrent_mode_id\x18\n" +
	" \x01(\x05R\rcurrentModeId\x12,\n" +
	"\x05modes\x18\v \x03(\v2\x16.CMsgSystemDisplayModeR\x05modes\x12(\n" +
	"\x10refresh_rate_min\x18\f \x01(\x05R\x0erefreshRateMin\x12(\n" +
	"\x10refresh_rate_max\x18\r \x01(\x05R\x0erefreshRateMax\x12$\n" +
	"\x0eis_vrr_capable\x18\x0e \x01(\bR\fisVrrCapable\x12/\n" +
	"\x14is_vrr_output_active\x18\x0f \x01(\bR\x11isVrrOutputActive\x12$\n" +
	"\x0eis_hdr_capable\x18\x10 \x01(\bR\fisHdrCapable\x12/\n" +
	"\x14is_hdr_output_active\x18\x11 \x01(\bR\x11isHdrOutputActive\x126\n" +
	"\x17supported_refresh_rates\x18\x12 \x03(\x05R\x15supportedRefreshRates\"\x8a\x02\n" +
	...
	"\x12compatibility_mode\x18\x03 \x01(\x0e2 .ESystemDisplayCompatibilityMode:)k_ESystemDisplayCompatibilityMode_InvalidR\x11compatibilityMode\"Y\n" +
	"\x1fCMsgSystemDisplayManagerSetMode\x12\x1d\n" +
	"\n" +
	"display_id\x18\x01 \x01(\x05R\tdisplayId\x12\x17\n" +
	"\amode_id\x18\x02 \x01(\x05R\x06modeId\"\xc1\x12\n" +
	...
	"\x1didle_backlight_dim_ac_seconds\x18\x02 \x01(\x02R\x19idleBacklightDimAcSeconds\x12?\n" +
	"\x1cidle_suspend_battery_seconds\x18\x03 \x01(\x02R\x19idleSuspendBatterySeconds\x125\n" +
	"\x17idle_suspend_ac_seconds\x18\x04 \x01(\x02R\x14idleSuspendAcSeconds\x124\n" +
	"\x16idle_suspend_supressed\x18\x05 \x01(\bR\x14idleSuspendSupressed\x12G\n" +
	" is_adaptive_brightness_available\x18\x06 \x01(\bR\x1disAdaptiveBrightnessAvailable\x12M\n" +
	"#display_adaptive_brightness_enabled\x18\a \x01(\bR displayAdaptiveBrightnessEnabled\x12:\n" +
	"\x19display_nightmode_enabled\x18\n" +
	" \x01(\bR\x17displayNightmodeEnabled\x12D\n" +
	"\x1edisplay_nightmode_tintstrength\x18\v \x01(\x02R\x1cdisplayNightmodeTintstrength\x128\n" +
	"\x18display_nightmode_maxhue\x18\f \x01(\x02R\x16displayNightmodeMaxhue\x128\n" +
	"\x18display_nightmode_maxsat\x18\r \x01(\x02R\x16displayNightmodeMaxsat\x126\n" +
	"\x17display_nightmode_uiexp\x18\x0e \x01(\x02R\x15displayNightmodeUiexp\x126\n" +
	"\x17display_nightmode_blend\x18\x0f \x01(\x02R\x15displayNightmodeBlend\x126\n" +
	"\x17display_nightmode_reset\x18\x10 \x01(\bR\x15displayNightmodeReset\x12K\n" +
	"\"display_nightmode_schedule_enabled\x18\x11 \x01(\bR\x1fdisplayNightmodeScheduleEnabled\x12O\n" +
	"$display_nightmode_schedule_starttime\x18\x12 \x01(\x02R!displayNightmodeScheduleStarttime\x12K\n" +
	"\"display_nightmode_schedule_endtime\x18\x13 \x01(\x02R\x1fdisplayNightmodeScheduleEndtime\x12>\n" +
	"\x1bdisplay_diagnostics_enabled\x18\x14 \x01(\bR\x19displayDiagnosticsEnabled\x12&\n" +
	"\x0fals_lux_primary\x18\x15 \x01(\x02R\ralsLuxPrimary\x12$\n" +
	...
	"$is_display_colormanagement_available\x18\x1f \x01(\bR!isDisplayColormanagementAvailable\x12-\n" +
	"\x12display_colorgamut\x18  \x01(\x02R\x11displayColorgamut\x12*\n" +
	"\x11als_lux_alternate\x18! \x01(\x02R\x0falsLuxAlternate\x12C\n" +
	"\x1eis_display_colortemp_available\x18\" \x01(\bR\x1bisDisplayColortempAvailable\x12+\n" +
	"\x11display_colortemp\x18# \x01(\x02R\x10displayColortemp\x12:\n" +
	"\x19display_colortemp_default\x18$ \x01(\x02R\x17displayColortempDefault\x12:\n" +
	"\x19display_colortemp_enabled\x18% \x01(\bR\x17displayColortempEnabled\x12r\n" +
	"\x1bdisplay_colorgamut_labelset\x18& \x01(\x0e2\x14.EColorGamutLabelSet:\x1ck_ColorGamutLabelSet_DefaultR\x19displayColorgamutLabelset\x12R\n" +
	"&display_brightness_overdrive_hdr_split\x18' \x01(\x02R\"displayBrightnessOverdriveHdrSplit\"x\n" +
	"\x18CMsgSelectOSBranchParams\x127\n" +
	"\x06branch\x18\x01 \x01(\x0e2\n" +
	".EOSBranch:\x13k_EOSBranch_UnknownR\x06branch\x12#\n" +
	"\rcustom_branch\x18\x02 \x01(\tR\fcustomBranch\"\xa9\x01\n" +
	"\x18CMsgSystemUpdateProgress\x12%\n" +
	"\x0estage_progress\x18\x01 \x01(\x02R\rstageProgress\x12(\n" +
	"\x10stage_size_bytes\x18\x02 \x01(\x03R\x0estageSizeBytes\x12<\n" +
	"\x1artime_estimated_completion\x18\x03 \x01(\aR\x18rtimeEstimatedCompletion\"\xab\x02\n" +
	"\x1bCMsgSystemUpdateCheckResult\x129\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.EUpdaterType:\x16k_EUpdaterType_InvalidR\x04type\x12\x1b\n" +
	"\aeresult\x18\x02 \x01(\r:\x012R\aeresult\x12#\n" +
	"\rrtime_checked\x18\x03 \x01(\aR\frtimeChecked\x12\x1c\n" +
	"\tavailable\x18\x04 \x01(\bR\tavailable\x12\x18\n" +
	"\aversion\x18\x05 \x01(\tR\aversion\x12!\n" +
	"\fauto_message\x18\x06 \x01(\tR\vautoMessage\x124\n" +
	"\x16system_restart_pending\x18\a \x01(\bR\x14systemRestartPending\"M\n" +
	"\x1bCMsgSystemUpdateApplyParams\x12.\n" +
	"\vapply_types\x18\x01 \x03(\x0e2\r.EUpdaterTypeR\n" +
	"applyTypes\"\xf3\x01\n" +
	"\x1bCMsgSystemUpdateApplyResult\x129\n" +
	"\x04type\x18\x01 \x01(\x0e2\r.EUpdaterType:\x16k_EUpdaterType_InvalidR\x04type\x12\x1b\n" +
	"\aeresult\x18\x02 \x01(\r:\x012R\aeresult\x12=\n" +
	"\x17requires_client_restart\x18\x03 \x01(\b:\x05falseR\x15requiresClientRestart\x12=\n" +
	"\x17requires_system_restart\x18\x04 \x01(\b:\x05falseR\x15requiresSystemRestart\"\xdd\x02\n" +
	"\x15CMsgSystemUpdateState\x12=\n" +
	"\x05state\x18\x01 \x01(\x0e2\x0e.EUpdaterState:\x17k_EUpdaterState_InvalidR\x05state\x125\n" +
	"\bprogress\x18\x02 \x01(\v2\x19.CMsgSystemUpdateProgressR\bprogress\x12N\n" +
	"\x14update_check_results\x18\x03 \x03(\v2\x1c.CMsgSystemUpdateCheckResultR\x12updateCheckResults\x12N\n" +
	"\x14update_apply_results\x18\x04 \x03(\v2\x1c.CMsgSystemUpdateApplyResultR\x12updateApplyResults\x12.\n" +
	"\x13supports_os_updates\x18\x05 \x01(\bR\x11supportsOsUpdates\"-\n" +
	"\x15CMsgAchievementChange\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\"t\n" +
	"\fCMsgCellList\x12(\n" +
	"\x05cells\x18\x01 \x03(\v2\x12.CMsgCellList.CellR\x05cells\x1a:\n" +
	"\x04Cell\x12\x17\n" +
	"\acell_id\x18\x01 \x01(\rR\x06cellId\x12\x19\n" +
	"\bloc_name\x18\x02 \x01(\tR\alocName\"\xbe\x05\n" +
	"\x10CMsgShortcutInfo\x12\x14\n" +
	"\x05appid\x18\x01 \x01(\rR\x05appid\x12\x10\n" +
	"\x03exe\x18\x02 \x01(\tR\x03exe\x12\x1b\n" +
	"\tstart_dir\x18\x03 \x01(\tR\bstartDir\x12\x12\n" +
	"\x04icon\x18\x04 \x01(\tR\x04icon\x12\x12\n" +
	"\x04path\x18\x05 \x01(\tR\x04path\x12\x12\n" +
	"\x04args\x18\x06 \x01(\tR\x04args\x12\x19\n" +
	"\bapp_name\x18\a \x01(\tR\aappName\x12%\n" +
	"\x0eoverride_appid\x18\b \x01(\rR\roverrideAppid\x12#\n" +
	"\rflatpak_appid\x18\t \x01(\tR\fflatpakAppid\x12\x12\n" +
	"\x04tags\x18\n" +
	" \x03(\tR\x04tags\x12(\n" +
	"\x10remote_client_id\x18\v \x01(\x04R\x0eremoteClientId\x12\x1b\n" +
	"\tis_hidden\x18\f \x01(\bR\bisHidden\x12!\n" +
	"\fis_temporary\x18\r \x01(\bR\visTemporary\x12\x1b\n" +
	"\tis_openvr\x18\x0e \x01(\bR\bisOpenvr\x120\n" +
	"\x14allow_desktop_config\x18\x0f \x01(\bR\x12allowDesktopConfig\x12#\n" +
	"\rallow_overlay\x18\x10 \x01(\bR\fallowOverlay\x12-\n" +
	"\x13rt_last_played_time\x18\x11 \x01(\rR\x10rtLastPlayedTime\x12,\n" +
	"\x12is_devkit_shortcut\x18\x12 \x01(\bR\x10isDevkitShortcut\x12#\n" +
	"\rdevkit_gameid\x18\x13 \x01(\tR\fdevkitGameid\x126\n" +
	"\x17remote_launch_available\x18\x14 \x01(\bR\x15remoteLaunchAvailable\x12\x16\n" +
	"\x06sortas\x18\x15 \x01(\tR\x06sortas\"B\n" +
	...
	"\x14monitor_display_name\x18\x02 \x02(\tR\x12monitorDisplayName\"<\n" +
	"\x1dCMsgGenerateSystemReportReply\x12\x1b\n" +
	"\treport_id\x18\x01 \x01(\tR\breportId\"G\n" +
	"\x16CMsgWebUITransportInfo\x12\x12\n" +
	"\x04port\x18\x01 \x01(\rR\x04port\x12\x19\n" +
	"\bauth_key\x18\x02 \x01(\tR\aauthKey\"@\n" +
	"\x19CMsgWebUITransportFailure\x12#\n" +
	"\rconnect_count\x18\x01 \x01(\rR\fconnectCount\"\x81\x01\n" +
	"\x1dCMsgClientShaderHitCacheEntry\x12\x17\n" +
	"\akey_sha\x18\x01 \x01(\fR\x06keySha\x12\x19\n" +
	"\bcode_sha\x18\x02 \x01(\fR\acodeSha\x12,\n" +
	"\x12time_last_reported\x18\x03 \x01(\x04R\x10timeLastReported\"T\n" +
	"\x18CMsgClientShaderHitCache\x128\n" +
	"\aentries\x18\x01 \x03(\v2\x1e.CMsgClientShaderHitCacheEntryR\aentries*\x96\x02\n" +
	"\x1cECloudPendingRemoteOperation\x12&\n" +
	"\"k_ECloudPendingRemoteOperationNone\x10\x00\x122\n" +
	".k_ECloudPendingRemoteOperationAppSessionActive\x10\x01\x122\n" +
	".k_ECloudPendingRemoteOperationUploadInProgress\x10\x02\x12/\n" +
	"+k_ECloudPendingRemoteOperationUploadPending\x10\x03\x125\n" +
	"1k_ECloudPendingRemoteOperationAppSessionSuspended\x10\x04*\xca\f\n" +
	"\x18ESteamDeckKeyboardLayout\x12%\n" +
	"!k_ESteamDeckKeyboardLayout_QWERTY\x10\x00\x12(\n" +
	"$k_ESteamDeckKeyboardLayout_Bulgarian\x10\x01\x121\n" +
	"-k_ESteamDeckKeyboardLayout_Chinese_Simplified\x10\x02\x122\n" +
	...
	"!k_ESteamDeckKeyboardLayout_French\x10\a\x12%\n" +
	"!k_ESteamDeckKeyboardLayout_German\x10\b\x12$\n" +
	" k_ESteamDeckKeyboardLayout_Greek\x10\t\x12(\n" +
	"$k_ESteamDeckKeyboardLayout_Hungarian\x10\n" +
	"\x12&\n" +
	"\"k_ESteamDeckKeyboardLayout_Italian\x10\v\x12'\n" +
	"#k_ESteamDeckKeyboardLayout_Japanese\x10\f\x12%\n" +
	...
	"%k_ESteamDeckKeyboardLayout_Vietnamese\x10\x19\x123\n" +
	...
	"9k_ESteamDeckKeyboardLayout_Bulgarian_Phonetic_Traditional\x10\x1d\x121\n" +
	...
	"%k_ESteamDeckKeyboardLayout_Indonesian\x10#B\x05H\x01\x80\x01\x00"

var (
	file_steammessages_client_objects_proto_rawDescOnce sync.Once
	file_steammessages_client_objects_proto_rawDescData []byte
)

func file_steammessages_client_objects_proto_rawDescGZIP() []byte {
	file_steammessages_client_objects_proto_rawDescOnce.Do(func() {
		file_steammessages_client_objects_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_steammessages_client_objects_proto_rawDesc), len(file_steammessages_client_objects_proto_rawDesc)))
	})
...
var file_steammessages_client_objects_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
var file_steammessages_client_objects_proto_goTypes = []any{
	...
	(*CMsgSystemPerfLegacySettingEntry)(nil),                 // 23: CMsgSystemPerfLegacySettingEntry
	(*CMsgSystemPerfLegacySettings)(nil),                     // 24: CMsgSystemPerfLegacySettings
	(*CMsgSystemDockUpdateState)(nil),                        // 25: CMsgSystemDockUpdateState
	(*CMsgSystemDockState)(nil),                              // 26: CMsgSystemDockState
	(*CMsgSystemDockUpdateFirmware)(nil),                     // 27: CMsgSystemDockUpdateFirmware
	(*CMsgSystemAudioVolume)(nil),                            // 28: CMsgSystemAudioVolume
	(*CMsgSystemAudioManagerObject)(nil),                     // 29: CMsgSystemAudioManagerObject
	(*CMsgSystemAudioManagerDevice)(nil),                     // 30: CMsgSystemAudioManagerDevice
	(*CMsgSystemAudioManagerNode)(nil),                       // 31: CMsgSystemAudioManagerNode
	(*CMsgSystemAudioManagerPort)(nil),                       // 32: CMsgSystemAudioManagerPort
	(*CMsgSystemAudioManagerLink)(nil),                       // 33: CMsgSystemAudioManagerLink
	(*CMsgSystemAudioManagerStateHW)(nil),                    // 34: CMsgSystemAudioManagerStateHW
	(*CMsgSystemAudioManagerState)(nil),                      // 35: CMsgSystemAudioManagerState
	(*CMsgSystemAudioManagerUpdateSomething)(nil),            // 36: CMsgSystemAudioManagerUpdateSomething
	(*CMsgSystemDisplayMode)(nil),                            // 37: CMsgSystemDisplayMode
	(*CMsgSystemDisplay)(nil),                                // 38: CMsgSystemDisplay
	(*CMsgSystemDisplayManagerState)(nil),                    // 39: CMsgSystemDisplayManagerState
	(*CMsgSystemDisplayManagerSetMode)(nil),                  // 40: CMsgSystemDisplayManagerSetMode
	(*CMsgSystemManagerSettings)(nil),                        // 41: CMsgSystemManagerSettings
	(*CMsgSelectOSBranchParams)(nil),                         // 42: CMsgSelectOSBranchParams
	(*CMsgSystemUpdateProgress)(nil),                         // 43: CMsgSystemUpdateProgress
	(*CMsgSystemUpdateCheckResult)(nil),                      // 44: CMsgSystemUpdateCheckResult
	(*CMsgSystemUpdateApplyParams)(nil),                      // 45: CMsgSystemUpdateApplyParams
	(*CMsgSystemUpdateApplyResult)(nil),                      // 46: CMsgSystemUpdateApplyResult
	(*CMsgSystemUpdateState)(nil),                            // 47: CMsgSystemUpdateState
	(*CMsgAchievementChange)(nil),                            // 48: CMsgAchievementChange
	(*CMsgCellList)(nil),                                     // 49: CMsgCellList
	(*CMsgShortcutInfo)(nil),                                 // 50: CMsgShortcutInfo
	(*CMsgShortcutInfos)(nil),                                // 51: CMsgShortcutInfos
	(*CMsgShortcutAppIds)(nil),                               // 52: CMsgShortcutAppIds
	(*CMsgMonitorInfo)(nil),                                  // 53: CMsgMonitorInfo
	(*CMsgGenerateSystemReportReply)(nil),                    // 54: CMsgGenerateSystemReportReply
	(*CMsgWebUITransportInfo)(nil),                           // 55: CMsgWebUITransportInfo
	(*CMsgWebUITransportFailure)(nil),                        // 56: CMsgWebUITransportFailure
	(*CMsgClientShaderHitCacheEntry)(nil),                    // 57: CMsgClientShaderHitCacheEntry
	(*CMsgClientShaderHitCache)(nil),                         // 58: CMsgClientShaderHitCache
	(*CMsgNetworkDevicesData_Device)(nil),                    // 59: CMsgNetworkDevicesData.Device
	(*CMsgNetworkDevicesData_Device_Wired)(nil),              // 60: CMsgNetworkDevicesData.Device.Wired
	(*CMsgNetworkDevicesData_Device_Wireless)(nil),           // 61: CMsgNetworkDevicesData.Device.Wireless
	(*CMsgNetworkDevicesData_Device_Wireless_AP)(nil),        // 62: CMsgNetworkDevicesData.Device.Wireless.AP
	(*CMsgNetworkDeviceConnect_KnownAP)(nil),                 // 63: CMsgNetworkDeviceConnect.KnownAP
	(*CMsgNetworkDeviceConnect_CustomAP)(nil),                // 64: CMsgNetworkDeviceConnect.CustomAP
	(*CMsgNetworkDeviceConnect_Credentials)(nil),             // 65: CMsgNetworkDeviceConnect.Credentials
	(*CMsgStorageDevicesData_Drive)(nil),                     // 66: CMsgStorageDevicesData.Drive
	(*CMsgStorageDevicesData_BlockDevice)(nil),               // 67: CMsgStorageDevicesData.BlockDevice
	(*CMsgBluetoothDevicesData_Adapter)(nil),                 // 68: CMsgBluetoothDevicesData.Adapter
	(*CMsgBluetoothDevicesData_Device)(nil),                  // 69: CMsgBluetoothDevicesData.Device
	(*CMsgBluetoothDevicesData_Manager)(nil),                 // 70: CMsgBluetoothDevicesData.Manager
	(*CMsgSystemAudioVolume_ChannelEntry)(nil),               // 71: CMsgSystemAudioVolume.ChannelEntry
	(*CMsgCellList_Cell)(nil),                                // 72: CMsgCellList.Cell
	(*CMsgMonitorInfo_MonitorInfo)(nil),                      // 73: CMsgMonitorInfo.MonitorInfo
	(EBluetoothDeviceType)(0),                                // 74: EBluetoothDeviceType
	(EStorageBlockContentType)(0),                            // 75: EStorageBlockContentType
	(EStorageBlockFileSystemType)(0),                         // 76: EStorageBlockFileSystemType
	(ESDCardFormatStage)(0),                                  // 77: ESDCardFormatStage
	(EGPUPerformanceLevel)(0),                                // 78: EGPUPerformanceLevel
	(ESplitScalingFilter)(0),                                 // 79: ESplitScalingFilter
	(ESplitScalingScaler)(0),                                 // 80: ESplitScalingScaler
	(ESystemServiceState)(0),                                 // 81: ESystemServiceState
	(EGraphicsPerfOverlayLevel)(0),                           // 82: EGraphicsPerfOverlayLevel
	(EHDRToneMapOperator)(0),                                 // 83: EHDRToneMapOperator
	(ECPUGovernor)(0),                                        // 84: ECPUGovernor
	(EUpdaterState)(0),                                       // 85: EUpdaterState
	(ESystemAudioDirection)(0),                               // 86: ESystemAudioDirection
	(ESystemAudioPortType)(0),                                // 87: ESystemAudioPortType
	(ESystemAudioPortDirection)(0),                           // 88: ESystemAudioPortDirection
	(ESystemDisplayCompatibilityMode)(0),                     // 89: ESystemDisplayCompatibilityMode
	(ESystemFanControlMode)(0),                               // 90: ESystemFanControlMode
	(EColorGamutLabelSet)(0),                                 // 91: EColorGamutLabelSet
	(EOSBranch)(0),                                           // 92: EOSBranch
	(EUpdaterType)(0),                                        // 93: EUpdaterType
	(EStorageDriveMediaType)(0),                              // 94: EStorageDriveMediaType
	(ESystemAudioChannel)(0),                                 // 95: ESystemAudioChannel
}
var file_steammessages_client_objects_proto_depIdxs = []int32{
	74, // 0: SteamMessagesClientIClientForcedEnumDependencies.a:type_name -> EBluetoothDeviceType
	75, // 1: SteamMessagesClientIClientForcedEnumDependencies.b:type_name -> EStorageBlockContentType
	76, // 2: SteamMessagesClientIClientForcedEnumDependencies.c:type_name -> EStorageBlockFileSystemType
	77, // 3: SteamMessagesClientIClientForcedEnumDependencies.d:type_name -> ESDCardFormatStage
	...
	59, // 6: CMsgNetworkDevicesData.devices:type_name -> CMsgNetworkDevicesData.Device
	65, // 7: CMsgNetworkDeviceConnect.credentials:type_name -> CMsgNetworkDeviceConnect.Credentials
	...
	63, // 10: CMsgNetworkDeviceConnect.ap_known:type_name -> CMsgNetworkDeviceConnect.KnownAP
	64, // 11: CMsgNetworkDeviceConnect.ap_custom:type_name -> CMsgNetworkDeviceConnect.CustomAP
	66, // 12: CMsgStorageDevicesData.drives:type_name -> CMsgStorageDevicesData.Drive
	67, // 13: CMsgStorageDevicesData.block_devices:type_name -> CMsgStorageDevicesData.BlockDevice
	...
	68, // 16: CMsgBluetoothDevicesData.adapters:type_name -> CMsgBluetoothDevicesData.Adapter
	69, // 17: CMsgBluetoothDevicesData.devices:type_name -> CMsgBluetoothDevicesData.Device
	70, // 18: CMsgBluetoothDevicesData.manager:type_name -> CMsgBluetoothDevicesData.Manager
	...
	78, // 21: CMsgSystemPerfLimits.gpu_performance_levels_available:type_name -> EGPUPerformanceLevel
	79, // 22: CMsgSystemPerfLimits.split_scaling_filters_available:type_name -> ESplitScalingFilter
	80, // 23: CMsgSystemPerfLimits.split_scaling_scalers_available:type_name -> ESplitScalingScaler
	81, // 24: CMsgSystemPerfSettingsGlobal.system_trace_service_state:type_name -> ESystemServiceState
	81, // 25: CMsgSystemPerfSettingsGlobal.graphics_profiling_service_state:type_name -> ESystemServiceState
	81, // 26: CMsgSystemPerfSettingsGlobal.perf_overlay_service_state:type_name -> ESystemServiceState
	82, // 27: CMsgSystemPerfSettingsGlobal.perf_overlay_level:type_name -> EGraphicsPerfOverlayLevel
	83, // 28: CMsgSystemPerfSettingsGlobal.hdr_on_sdr_tonemap_operator:type_name -> EHDRToneMapOperator
	84, // 29: CMsgSystemPerfSettingsPerApp.cpu_governor:type_name -> ECPUGovernor
	78, // 30: CMsgSystemPerfSettingsPerApp.gpu_performance_level:type_name -> EGPUPerformanceLevel
	79, // 31: CMsgSystemPerfSettingsPerApp.split_scaling_filter:type_name -> ESplitScalingFilter
	80, // 32: CMsgSystemPerfSettingsPerApp.split_scaling_scaler:type_name -> ESplitScalingScaler
	...
	81, // 35: CMsgSystemPerfSettingsV1.system_trace_service_state:type_name -> ESystemServiceState
	81, // 36: CMsgSystemPerfSettingsV1.graphics_profiling_service_state:type_name -> ESystemServiceState
	81, // 37: CMsgSystemPerfSettingsV1.perf_overlay_service_state:type_name -> ESystemServiceState
	82, // 38: CMsgSystemPerfSettingsV1.perf_overlay_level:type_name -> EGraphicsPerfOverlayLevel
	78, // 39: CMsgSystemPerfSettingsV1.gpu_performance_level:type_name -> EGPUPerformanceLevel
	84, // 40: CMsgSystemPerfSettingsV1.cpu_governor:type_name -> ECPUGovernor
	...
	18, // 44: CMsgSystemPerfLegacySettingEntry.settings:type_name -> CMsgSystemPerfSettingsPerApp
	17, // 45: CMsgSystemPerfLegacySettings.global:type_name -> CMsgSystemPerfSettingsGlobal
	23, // 46: CMsgSystemPerfLegacySettings.per_app_settings:type_name -> CMsgSystemPerfLegacySettingEntry
	85, // 47: CMsgSystemDockUpdateState.state:type_name -> EUpdaterState
	25, // 48: CMsgSystemDockState.update_state:type_name -> CMsgSystemDockUpdateState
	71, // 49: CMsgSystemAudioVolume.entries:type_name -> CMsgSystemAudioVolume.ChannelEntry
	29, // 50: CMsgSystemAudioManagerDevice.base:type_name -> CMsgSystemAudioManagerObject
	29, // 51: CMsgSystemAudioManagerNode.base:type_name -> CMsgSystemAudioManagerObject
	86, // 52: CMsgSystemAudioManagerNode.edirection:type_name -> ESystemAudioDirection
	28, // 53: CMsgSystemAudioManagerNode.volume:type_name -> CMsgSystemAudioVolume
	29, // 54: CMsgSystemAudioManagerPort.base:type_name -> CMsgSystemAudioManagerObject
	87, // 55: CMsgSystemAudioManagerPort.etype:type_name -> ESystemAudioPortType
	88, // 56: CMsgSystemAudioManagerPort.edirection:type_name -> ESystemAudioPortDirection
	29, // 57: CMsgSystemAudioManagerLink.base:type_name -> CMsgSystemAudioManagerObject
	30, // 58: CMsgSystemAudioManagerStateHW.devices:type_name -> CMsgSystemAudioManagerDevice
	31, // 59: CMsgSystemAudioManagerStateHW.nodes:type_name -> CMsgSystemAudioManagerNode
	32, // 60: CMsgSystemAudioManagerStateHW.ports:type_name -> CMsgSystemAudioManagerPort
	33, // 61: CMsgSystemAudioManagerStateHW.links:type_name -> CMsgSystemAudioManagerLink
	34, // 62: CMsgSystemAudioManagerState.hw:type_name -> CMsgSystemAudioManagerStateHW
	37, // 63: CMsgSystemDisplay.modes:type_name -> CMsgSystemDisplayMode
	38, // 64: CMsgSystemDisplayManagerState.displays:type_name -> CMsgSystemDisplay
	89, // 65: CMsgSystemDisplayManagerState.compatibility_mode:type_name -> ESystemDisplayCompatibilityMode
	90, // 66: CMsgSystemManagerSettings.fan_control_mode:type_name -> ESystemFanControlMode
	91, // 67: CMsgSystemManagerSettings.display_colorgamut_labelset:type_name -> EColorGamutLabelSet
	92, // 68: CMsgSelectOSBranchParams.branch:type_name -> EOSBranch
	93, // 69: CMsgSystemUpdateCheckResult.type:type_name -> EUpdaterType
	93, // 70: CMsgSystemUpdateApplyParams.apply_types:type_name -> EUpdaterType
	93, // 71: CMsgSystemUpdateApplyResult.type:type_name -> EUpdaterType
	85, // 72: CMsgSystemUpdateState.state:type_name -> EUpdaterState
	43, // 73: CMsgSystemUpdateState.progress:type_name -> CMsgSystemUpdateProgress
	44, // 74: CMsgSystemUpdateState.update_check_results:type_name -> CMsgSystemUpdateCheckResult
	46, // 75: CMsgSystemUpdateState.update_apply_results:type_name -> CMsgSystemUpdateApplyResult
	72, // 76: CMsgCellList.cells:type_name -> CMsgCellList.Cell
	50, // 77: CMsgShortcutInfos.shorcuts:type_name -> CMsgShortcutInfo
	73, // 78: CMsgMonitorInfo.monitors:type_name -> CMsgMonitorInfo.MonitorInfo
	57, // 79: CMsgClientShaderHitCache.entries:type_name -> CMsgClientShaderHitCacheEntry
	...
	60, // 82: CMsgNetworkDevicesData.Device.wired:type_name -> CMsgNetworkDevicesData.Device.Wired
	61, // 83: CMsgNetworkDevicesData.Device.wireless:type_name -> CMsgNetworkDevicesData.Device.Wireless
	62, // 84: CMsgNetworkDevicesData.Device.Wireless.aps:type_name -> CMsgNetworkDevicesData.Device.Wireless.AP
	94, // 85: CMsgStorageDevicesData.Drive.media_type:type_name -> EStorageDriveMediaType
	75, // 86: CMsgStorageDevicesData.BlockDevice.content_type:type_name -> EStorageBlockContentType
	76, // 87: CMsgStorageDevicesData.BlockDevice.filesystem_type:type_name -> EStorageBlockFileSystemType
	74, // 88: CMsgBluetoothDevicesData.Device.etype:type_name -> EBluetoothDeviceType
	95, // 89: CMsgSystemAudioVolume.ChannelEntry.echannel:type_name -> ESystemAudioChannel
...
func file_steammessages_client_objects_proto_init() {
	...
	file_steammessages_client_objects_proto_msgTypes[6].OneofWrappers = []any{
		(*CMsgNetworkDeviceConnect_ApKnown)(nil),
		(*CMsgNetworkDeviceConnect_ApCustom)(nil),
	}
	file_steammessages_client_objects_proto_msgTypes[20].OneofWrappers = []any{
