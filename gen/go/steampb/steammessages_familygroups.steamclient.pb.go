...
const file_steammessages_familygroups_steamclient_proto_rawDesc = "" +
	...
	"\x1dinclude_family_group_response\x18\x02 \x01(\bR\x1aincludeFamilyGroupResponse\"\xd4\x01\n" +
	...
	"\fawaiting_2fa\x18\x04 \x01(\bR\vawaiting2fa\"\xb8\x04\n" +
	...
	"\x1fcan_undelete_last_joined_family\x18\t \x01(\bR\x1bcanUndeleteLastJoinedFamily\"k\n" +
	...
	"\x05nonce\x18\x02 \x01(\x04R\x05nonce\"\x83\x02\n" +
	...
	"\x17invite_already_accepted\x18\x04 \x01(\bR\x15inviteAlreadyAccepted\"\x88\x01\n" +
	...
	"(CFamilyGroups_ClearCooldownSkip_Response\"\xac\x03\n" +
	...
	")k_ESharedLibrary_LicenseExcluded_Inactive\x10\x1e2\xb4\x17\n" +
	"\fFamilyGroups\x12h\n" +
	...
	"\x11ClearCooldownSkip\x12(.CFamilyGroups_ClearCooldownSkip_Request\x1a).CFamilyGroups_ClearCooldownSkip_Response2\x97\x02\n" +
