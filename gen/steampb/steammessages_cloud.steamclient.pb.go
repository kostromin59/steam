...
func (*ClientCloudFileUploadBlockDetails_HTTPHeaders) Descriptor() ([]byte, []int) {
	return file_steammessages_cloud_steamclient_proto_rawDescGZIP(), []int{27, 0}
}
...
func (*CCloud_ClientFileDownload_Response_HTTPHeaders) Descriptor() ([]byte, []int) {
	return file_steammessages_cloud_steamclient_proto_rawDescGZIP(), []int{32, 0}
}
...
const file_steammessages_cloud_steamclient_proto_rawDesc = "" +
	...
	"\n" +
	"request_id\x18\x01 \x01(\x04R\trequestId2\xb2\x12\n" +
	"\x05Cloud\x12N\n" +
...
var file_steammessages_cloud_steamclient_proto_msgTypes = make([]protoimpl.MessageInfo, 54)
var file_steammessages_cloud_steamclient_proto_goTypes = []any{
	...
	(*CCloud_EnumerateUserFiles_Request)(nil),                 // 13: CCloud_EnumerateUserFiles_Request
	(*CCloud_EnumerateUserFiles_Response)(nil),                // 14: CCloud_EnumerateUserFiles_Response
	(*CCloud_Delete_Request)(nil),                             // 15: CCloud_Delete_Request
	(*CCloud_Delete_Response)(nil),                            // 16: CCloud_Delete_Response
	(*CCloud_GetClientEncryptionKey_Request)(nil),             // 17: CCloud_GetClientEncryptionKey_Request
	(*CCloud_GetClientEncryptionKey_Response)(nil),            // 18: CCloud_GetClientEncryptionKey_Response
	(*CCloud_CDNReport_Notification)(nil),                     // 19: CCloud_CDNReport_Notification
	(*CCloud_ExternalStorageTransferReport_Notification)(nil), // 20: CCloud_ExternalStorageTransferReport_Notification
	(*CCloud_BeginAppUploadBatch_Request)(nil),                // 21: CCloud_BeginAppUploadBatch_Request
	(*CCloud_BeginAppUploadBatch_Response)(nil),               // 22: CCloud_BeginAppUploadBatch_Response
	(*CCloud_CompleteAppUploadBatch_Notification)(nil),        // 23: CCloud_CompleteAppUploadBatch_Notification
	(*CCloud_CompleteAppUploadBatch_Request)(nil),             // 24: CCloud_CompleteAppUploadBatch_Request
	(*CCloud_CompleteAppUploadBatch_Response)(nil),            // 25: CCloud_CompleteAppUploadBatch_Response
	(*CCloud_ClientBeginFileUpload_Request)(nil),              // 26: CCloud_ClientBeginFileUpload_Request
	(*ClientCloudFileUploadBlockDetails)(nil),                 // 27: ClientCloudFileUploadBlockDetails
	(*CCloud_ClientBeginFileUpload_Response)(nil),             // 28: CCloud_ClientBeginFileUpload_Response
	(*CCloud_ClientCommitFileUpload_Request)(nil),             // 29: CCloud_ClientCommitFileUpload_Request
	(*CCloud_ClientCommitFileUpload_Response)(nil),            // 30: CCloud_ClientCommitFileUpload_Response
	(*CCloud_ClientFileDownload_Request)(nil),                 // 31: CCloud_ClientFileDownload_Request
	(*CCloud_ClientFileDownload_Response)(nil),                // 32: CCloud_ClientFileDownload_Response
	(*CCloud_ClientDeleteFile_Request)(nil),                   // 33: CCloud_ClientDeleteFile_Request
	(*CCloud_ClientDeleteFile_Response)(nil),                  // 34: CCloud_ClientDeleteFile_Response
	(*CCloud_ClientConflictResolution_Notification)(nil),      // 35: CCloud_ClientConflictResolution_Notification
	(*CCloud_GetAppFileChangelist_Request)(nil),               // 36: CCloud_GetAppFileChangelist_Request
	(*CCloud_AppFileInfo)(nil),                                // 37: CCloud_AppFileInfo
	(*CCloud_GetAppFileChangelist_Response)(nil),              // 38: CCloud_GetAppFileChangelist_Response
	(*CCloud_AppSessionSuspend_Request)(nil),                  // 39: CCloud_AppSessionSuspend_Request
	(*CCloud_AppSessionSuspend_Response)(nil),                 // 40: CCloud_AppSessionSuspend_Response
	(*CCloud_AppSessionResume_Request)(nil),                   // 41: CCloud_AppSessionResume_Request
	(*CCloud_AppSessionResume_Response)(nil),                  // 42: CCloud_AppSessionResume_Response
	(*CCloud_AppLaunchIntent_Request)(nil),                    // 43: CCloud_AppLaunchIntent_Request
	(*CCloud_AppLaunchIntent_Response)(nil),                   // 44: CCloud_AppLaunchIntent_Response
	(*CCloud_AppExitSyncDone_Notification)(nil),               // 45: CCloud_AppExitSyncDone_Notification
	(*CCloud_ClientGetAppQuotaUsage_Request)(nil),             // 46: CCloud_ClientGetAppQuotaUsage_Request
	(*CCloud_ClientGetAppQuotaUsage_Response)(nil),            // 47: CCloud_ClientGetAppQuotaUsage_Response
	(*CCloud_AppCloudStateChange_Notification)(nil),           // 48: CCloud_AppCloudStateChange_Notification
	(*CCloud_ClientLogUploadRequest_Notification)(nil),        // 49: CCloud_ClientLogUploadRequest_Notification
	(*CCloud_BeginHTTPUpload_Response_HTTPHeaders)(nil),       // 50: CCloud_BeginHTTPUpload_Response.HTTPHeaders
	(*CCloud_BeginUGCUpload_Response_HTTPHeaders)(nil),        // 51: CCloud_BeginUGCUpload_Response.HTTPHeaders
	(*ClientCloudFileUploadBlockDetails_HTTPHeaders)(nil),     // 52: ClientCloudFileUploadBlockDetails.HTTPHeaders
	(*CCloud_ClientFileDownload_Response_HTTPHeaders)(nil),    // 53: CCloud_ClientFileDownload_Response.HTTPHeaders
	(EPublishedFileStorageSystem)(0),                          // 54: EPublishedFileStorageSystem
	(ECloudStoragePersistState)(0),                            // 55: ECloudStoragePersistState
	(*CCloud_PendingRemoteOperation)(nil),                     // 56: CCloud_PendingRemoteOperation
	(*NoResponse)(nil),                                        // 57: NoResponse
}
var file_steammessages_cloud_steamclient_proto_depIdxs = []int32{
	50, // 0: CCloud_BeginHTTPUpload_Response.request_headers:type_name -> CCloud_BeginHTTPUpload_Response.HTTPHeaders
	54, // 1: CCloud_BeginUGCUpload_Response.storage_system:type_name -> EPublishedFileStorageSystem
	51, // 2: CCloud_BeginUGCUpload_Response.request_headers:type_name -> CCloud_BeginUGCUpload_Response.HTTPHeaders
	...
	52, // 5: ClientCloudFileUploadBlockDetails.request_headers:type_name -> ClientCloudFileUploadBlockDetails.HTTPHeaders
	27, // 6: CCloud_ClientBeginFileUpload_Response.block_requests:type_name -> ClientCloudFileUploadBlockDetails
	53, // 7: CCloud_ClientFileDownload_Response.request_headers:type_name -> CCloud_ClientFileDownload_Response.HTTPHeaders
	55, // 8: CCloud_AppFileInfo.persist_state:type_name -> ECloudStoragePersistState
	37, // 9: CCloud_GetAppFileChangelist_Response.files:type_name -> CCloud_AppFileInfo
	56, // 10: CCloud_AppLaunchIntent_Response.pending_remote_operations:type_name -> CCloud_PendingRemoteOperation
	...
	13, // 18: Cloud.EnumerateUserFiles:input_type -> CCloud_EnumerateUserFiles_Request
	15, // 19: Cloud.Delete:input_type -> CCloud_Delete_Request
	17, // 20: Cloud.GetClientEncryptionKey:input_type -> CCloud_GetClientEncryptionKey_Request
	19, // 21: Cloud.CDNReport:input_type -> CCloud_CDNReport_Notification
	20, // 22: Cloud.ExternalStorageTransferReport:input_type -> CCloud_ExternalStorageTransferReport_Notification
	21, // 23: Cloud.BeginAppUploadBatch:input_type -> CCloud_BeginAppUploadBatch_Request
	23, // 24: Cloud.CompleteAppUploadBatch:input_type -> CCloud_CompleteAppUploadBatch_Notification
	24, // 25: Cloud.CompleteAppUploadBatchBlocking:input_type -> CCloud_CompleteAppUploadBatch_Request
	26, // 26: Cloud.ClientBeginFileUpload:input_type -> CCloud_ClientBeginFileUpload_Request
	29, // 27: Cloud.ClientCommitFileUpload:input_type -> CCloud_ClientCommitFileUpload_Request
	31, // 28: Cloud.ClientFileDownload:input_type -> CCloud_ClientFileDownload_Request
	33, // 29: Cloud.ClientDeleteFile:input_type -> CCloud_ClientDeleteFile_Request
	35, // 30: Cloud.ClientConflictResolution:input_type -> CCloud_ClientConflictResolution_Notification
	36, // 31: Cloud.GetAppFileChangelist:input_type -> CCloud_GetAppFileChangelist_Request
	39, // 32: Cloud.SuspendAppSession:input_type -> CCloud_AppSessionSuspend_Request
	41, // 33: Cloud.ResumeAppSession:input_type -> CCloud_AppSessionResume_Request
	43, // 34: Cloud.SignalAppLaunchIntent:input_type -> CCloud_AppLaunchIntent_Request
	45, // 35: Cloud.SignalAppExitSyncDone:input_type -> CCloud_AppExitSyncDone_Notification
	46, // 36: Cloud.ClientGetAppQuotaUsage:input_type -> CCloud_ClientGetAppQuotaUsage_Request
	48, // 37: CloudClient.NotifyAppStateChange:input_type -> CCloud_AppCloudStateChange_Notification
	49, // 38: CloudClient.ClientLogUploadRequest:input_type -> CCloud_ClientLogUploadRequest_Notification
	57, // 39: Cloud.ClientLogUploadCheck:output_type -> NoResponse
	57, // 40: Cloud.ClientLogUploadComplete:output_type -> NoResponse
	3,  // 41: Cloud.BeginHTTPUpload:output_type -> CCloud_BeginHTTPUpload_Response
	5,  // 42: Cloud.CommitHTTPUpload:output_type -> CCloud_CommitHTTPUpload_Response
	7,  // 43: Cloud.BeginUGCUpload:output_type -> CCloud_BeginUGCUpload_Response
	9,  // 44: Cloud.CommitUGCUpload:output_type -> CCloud_CommitUGCUpload_Response
	12, // 45: Cloud.GetFileDetails:output_type -> CCloud_GetFileDetails_Response
	14, // 46: Cloud.EnumerateUserFiles:output_type -> CCloud_EnumerateUserFiles_Response
	16, // 47: Cloud.Delete:output_type -> CCloud_Delete_Response
	18, // 48: Cloud.GetClientEncryptionKey:output_type -> CCloud_GetClientEncryptionKey_Response
	57, // 49: Cloud.CDNReport:output_type -> NoResponse
	57, // 50: Cloud.ExternalStorageTransferReport:output_type -> NoResponse
	22, // 51: Cloud.BeginAppUploadBatch:output_type -> CCloud_BeginAppUploadBatch_Response
	57, // 52: Cloud.CompleteAppUploadBatch:output_type -> NoResponse
	25, // 53: Cloud.CompleteAppUploadBatchBlocking:output_type -> CCloud_CompleteAppUploadBatch_Response
	28, // 54: Cloud.ClientBeginFileUpload:output_type -> CCloud_ClientBeginFileUpload_Response
	30, // 55: Cloud.ClientCommitFileUpload:output_type -> CCloud_ClientCommitFileUpload_Response
	32, // 56: Cloud.ClientFileDownload:output_type -> CCloud_ClientFileDownload_Response
	34, // 57: Cloud.ClientDeleteFile:output_type -> CCloud_ClientDeleteFile_Response
	57, // 58: Cloud.ClientConflictResolution:output_type -> NoResponse
	38, // 59: Cloud.GetAppFileChangelist:output_type -> CCloud_GetAppFileChangelist_Response
	40, // 60: Cloud.SuspendAppSession:output_type -> CCloud_AppSessionSuspend_Response
	42, // 61: Cloud.ResumeAppSession:output_type -> CCloud_AppSessionResume_Response
	44, // 62: Cloud.SignalAppLaunchIntent:output_type -> CCloud_AppLaunchIntent_Response
	57, // 63: Cloud.SignalAppExitSyncDone:output_type -> NoResponse
	47, // 64: Cloud.ClientGetAppQuotaUsage:output_type -> CCloud_ClientGetAppQuotaUsage_Response
	57, // 65: CloudClient.NotifyAppStateChange:output_type -> NoResponse
	57, // 66: CloudClient.ClientLogUploadRequest:output_type -> NoResponse
